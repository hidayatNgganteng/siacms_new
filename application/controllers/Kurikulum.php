...
// tutup anggrek
	...
	public function simpanmapel() {
		...
		print_r(count($tabel_kelasreguler));
	...
	// {
	// 	$this->template->load('kurikulum/dashboard','kurikulum/penjadwalan/kurikulum/printjadwalekskul');
	// }
