<?php
class Superpen extends CI_Controller {
    ...
    public function nilaisiswa(){
        ...
        $this->template->load('superadmin/dashboard','superadmin/kurikulum/penilaian/penilaian/nilaisiswa',$data);
    }
...
public function ubah_nilai(){
    ...
    $this->load->view('superadmin/kurikulum/penilaian/penilaian/nilaisiswa');   
...
public function form_edit_nilai(){
    $this->load->model('penilaian/M_data');
    $data['f']=$this->M_data->selectNilai($this->uri->segment(4));
    $this->load->view('superadmin/kurikulum/penilaian/penilaian/edit/edit_nilai',$data);
}
...
public function exportnilai() {
  ...
  $this->load->model('M_data');
    ...
    $this->load->view('superadmin/penilaian/penilaian/view_template_nilai',$data);
...
public function deskripsinilai(){
 ...
 $this->template->load('superadmin/dashboard','superadmin/kurikulum/penilaian/penilaian/deskripsinilai',$data);
}
...
public function tambah_desknilai(){
    ...
    $this->template->load('superadmin/dashboard','superadmin/kurikulum/penilaian/penilaian/deskripsinilai',$data);    
    redirect('superpen/deskripsinilai');
...
public function form_edit_deskripsi(){
    ...
    $this->load->view('superadmin/kurikulum/penilaian/penilaian/edit/edit_desknilai',$data);
}
...
public function kategorinilai(){
    ...
    $this->template->load('superadmin/dashboard', 'superadmin/kurikulum/penilaian/penilaian/kategorinilai',$data);
...
public function tambah_katnilai(){
    ...
    $this->load->view('superadmin/kurikulum/penilaian/penilaian/kategorinilai');     
    redirect('superpen/kategorinilai');
}
...
public function form_edit_kategori(){
    ...
    $this->load->view('superadmin/kurikulum/penilaian/penilaian/edit/edit_katnilai',$data);
}
...
public function jenisNA(){
    ...
    $data['username'] = $this->session->username;
    $data['jenis_nilai_akhir'] = $this->M_data->getJenisnilai()->result();
    $this->template->load('superadmin/dashboard','superadmin/kurikulum/penilaian/penilaian/jenisnilaiakhir',$data);
}
...
public function tambah_jenisnilai(){
    ...
    $this->load->view('superadmin/kurikulum/penilaian/penilaian/jenisnilaiakhir');     
    redirect('superpen/jenisNA');
}
...
public function form_edit_jenisNilai(){
    ...
    $this->load->view('superadmin/kurikulum/penilaian/penilaian/edit/edit_jenisNilai',$data);
...
public function rapor(){
    ...
    $this->template->load('superadmin/dashboard','superadmin/kurikulum/penilaian/penilaian/rapor',$data);
}
...
public function cetak_rapor() {
    ...
    $this->load->view('superadmin/kurikulum/penilaian/KBM/view_rapor_excel', $data);
}
...
public function Kompetensi(){
    ...
    $this->template->load('superadmin/dashboard','superadmin/kurikulum/penilaian/penilaian/Kompetensi',$data);
}
...
public function form_edit_kompetensi(){
    ...
    $this->load->view('superadmin/kurikulum/penilaian/penilaian/edit/edit_kompetensi',$data);
}
