...
class Daftarulang_kenaikan extends CI_Controller {
  ...
  public function index()
  {
    ...
    $this->template->load('kesiswaan/dashboard', 'kesiswaan/ppdb/admin/view_daftarulang_kenaikan', $data);
  }
  ...
  public function saveformkenaikan() {
		...
		redirect('ppdb/admin/daftarulang_kenaikan');
	}
	...
	public function editberkas()
    {
        ...
        $this->load->view('kesiswaan/ppdb/admin/view_edit_berkas_kenaikan', $data);
    }
