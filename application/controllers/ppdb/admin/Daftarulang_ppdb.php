...
class Daftarulang_ppdb extends CI_Controller {
  ...
  public function index()
  {
    ...
    $this->template->load('kesiswaan/dashboard', 'kesiswaan/ppdb/admin/view_daftarulang_ppdb', $data);
  }
  ...
  public function saveformppdb() 
    {
        ...
        redirect('ppdb/admin/daftarulang_ppdb');
    }
    ...
    public function editketentuan()
    {
        ...
        $this->load->view('kesiswaan/ppdb/admin/view_edit_ketentuan_daftarulang', $data);
    }
    ...
    public function editberkas()
    {
        ...
        $this->load->view('kesiswaan/ppdb/admin/view_edit_berkas_daftarulang', $data);
    }
    ...
    public function editpengumuman()
    {
        ...
        $this->load->view('kesiswaan/ppdb/admin/view_edit_pengumuman_daftarulang', $data);
    }
    ...
    public function eksportujian()
    {
        ...
        $this->load->view('kesiswaan/ppdb/admin/view_excel_daftarulang_ppdb', $data);
    }
