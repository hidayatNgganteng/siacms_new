...
class Buku_induk extends CI_Controller {
  ...
  public function index()
  {
    ...
    $this->template->load('superadmin/dashboard', 'superadmin/ppdb/admin/view_buku_induk', $data);
  }
  	...
  	public function editsiswa()
	{
		...
		$this->load->view('superadmin/ppdb/admin/view_edit_siswa', $data);
	}
	...
	public function updatesiswa() 
	{
		...
		redirect('suppdb/admin/buku_induk');
	}
	...
	{	
		...
		$this->load->view('superadmin/ppdb/admin/view_edit_siswa_ortu', $data);
	}
	...
	{	
		...
		$this->load->view('superadmin/ppdb/admin/view_edit_siswa_wali', $data);
	}
