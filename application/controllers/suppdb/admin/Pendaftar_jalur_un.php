...
class Pendaftar_jalur_un extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('superadmin/dashboard', 'superadmin/ppdb/admin/view_pendaftar_jalur_un', $data);
	}
	...
	public function saveformnegeri() 
	{
		...
		redirect('suppdb/admin/pendaftar_jalur_un');
	}
	...
	public function editketentuan()
	{
		...
		$this->load->view('superadmin/ppdb/admin/view_edit_ketentuan_negeri', $data);
	}
	...
	public function editnilai()
	{
		...
		$this->load->view('superadmin/ppdb/admin/view_lihat_nilai_ppdb_un', $data);
	}
	...
	public function editpendaftar()
	{
		...
		$this->load->view('superadmin/ppdb/admin/view_edit_pendaftar_ppdb_negeri', $data);
	}
	...
	public function editpendaftarlolos()
	{
		...
		$this->load->view('superadmin/ppdb/admin/view_edit_pendaftar_ppdb_negeri_lolos', $data);
	}
	...
	public function editpengumuman()
	{
		...
		$this->load->view('superadmin/ppdb/admin/view_edit_pengumuman_negeri', $data);
	}
	...
	public function eksportujian()
	{
		...
		$this->load->view('superadmin/admin/view_excel_ppdb_un', $data);
	}
