...
class M_data extends CI_Model{
	...
	function get_laporan(){
		return $this->db->get_where('pilih_laporan', array('id_pilihlap' => 0))->result();
	}

	function update_laporan($data){
		$this->db->where('id_pilihlap',0);
		$this->db->update('pilih_laporan',$data);
	}
	...
	function updatehakpresensi($data,$id){
