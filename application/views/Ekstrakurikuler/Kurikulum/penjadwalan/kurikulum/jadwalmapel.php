...
<!-- /.tab-pane -->
  ...
  <div class="tab-pane" id="kelolajadwalmapel">
    <div class="formmapel" style="display: block;padding: 1.5em;margin-bottom: 1.5em;">
      <div class="row">
        <div class="col-xs-6" style="margin: 0.25em 0;margin-top: 0;">
          <span style="font-weight: bold;">Hari : </span>
          <select class="form-control" id="harimapel_">
            <option value="senin" selected>Senin</option>
            <option value="selasa">Selasa</option>
            <option value="rabu">Rabu</option>
            <option value="kamis">Kamis</option>
        ...
        <div class="col-xs-6" style="margin: 0.25em 0;margin-top: 0;">
          <span style="font-weight: bold;">Jenjang : </span>
          <select class="kodepiket form-control" id="pilih_jenjang">
            <option value="" selected>Pilih Jenjang</option>
          </select>
        </div>
      </div>
    </div>
    <div class="box formmapel" style="border-top: 0;">
      <div class="box-body">

        <table class="table table-bordered table-striped tabelmapel tampilkan_ tampilkan-table" id="senin">
          <thead>
            <tr class="barishari" style="background: #009688;color: white">
              <th class="tengah text-center" rowspan="2" style="border: 0;">Jam Ke</th>
              <th class="tengah text-center" rowspan="2" style="border: 0;">Jam</th>
            ...
            <tr style="background: #009688;color: white">
              ...
              foreach ($tabel_kelasreguler as $key => $row_kelasreguler) {
                ?>
                <th class="text-center"><?php echo $row_kelasreguler->nama_kelas; ?></th>
                <?php
              }
              ?>
            </tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <th class="text-center" style="width: 50%">
                <?php echo @substr($hari_rentang['Senin'][$i]->jam_mulai,0,5)."-".@substr($hari_rentang['Senin'][$i]->jam_selesai,0,5); ?>
              </th>
              <td>
                <a class="btn btn-info" style="display: block;">Tambahkan</a>
              </td>
            </tr>
          <?php endfor ?>
          </tbody>
        ...
        <table class="table table-bordered table-striped tabelmapel tampilkan_" id="selasa">
          <thead>
            <tr class="barishari" style="background: #009688;color: white">
              <th class="tengah text-center" style="border: 0;">Jam</th>
              <!-- <th class="tengah" >Waktu</th> -->
              <th class="tengah text-center" style="border: 0;">Selasa</th>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr>
              <th class="text-center" style="width: 50%">
                <?php echo @substr($hari_rentang['Selasa'][$i]->jam_mulai,0,5)."-".@substr($hari_rentang['Selasa'][$i]->jam_selesai,0,5); ?>
              </th>
              <td>
                <a class="btn btn-info" style="display: block;">Tambahkan</a>
              </td>
        ...
        <table class="table table-bordered table-striped tabelmapel tampilkan_" id="rabu">
          <thead>
            <tr class="barishari" style="background: #009688;color: white">
              <th class="tengah text-center" style="border: 0;">Jam</th>
              <!-- <th class="tengah" >Waktu</th> -->
              <th class="tengah text-center" style="border: 0;">Rabu</th>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr>
              <th class="text-center" style="width: 50%">
                <?php echo @substr($hari_rentang['Rabu'][$i]->jam_mulai,0,5)."-".@substr($hari_rentang['Rabu'][$i]->jam_selesai,0,5); ?>
              </th>
              <td>
                <a class="btn btn-info" style="display: block;">Tambahkan</a>
              </td>
        ...
        <table class="table table-bordered table-striped tabelmapel tampilkan_" id="kamis">
          <thead>
            <tr class="barishari" style="background: #009688;color: white">
              <th class="tengah text-center" style="border: 0;">Jam</th>
              <!-- <th class="tengah" >Waktu</th> -->
              <th class="tengah text-center" style="border: 0;">Kamis</th>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr>
              <th class="text-center" style="width: 50%">
                <?php echo @substr($hari_rentang['Kamis'][$i]->jam_mulai,0,5)."-".@substr($hari_rentang['Kamis'][$i]->jam_selesai,0,5); ?>
              </th>
              <td>
                <a class="btn btn-info" style="display: block;">Tambahkan</a>
              </td>
        ...
        <table class="table table-bordered table-striped tabelmapel tampilkan_" id="jumat">
          <thead>
            <tr class="barishari" style="background: #009688;color: white">
              <th class="tengah text-center" style="border: 0;">Jam</th>
              <!-- <th class="tengah" >Waktu</th> -->
              <th class="tengah text-center" style="border: 0;">Jumat</th>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr>
              <th class="text-center" style="width: 50%">
                <?php echo @substr($hari_rentang['Jumat'][$i]->jam_mulai,0,5)."-".@substr($hari_rentang['Jumat'][$i]->jam_selesai,0,5); ?>
              </th>
              <td>
        ...
        <table class="table table-bordered table-striped tabelmapel tampilkan_" id="sabtu">
          <thead>
            <tr class="barishari" style="background: #009688;color: white">
              <th class="tengah text-center" style="border: 0;">Jam</th>
              <!-- <th class="tengah" >Waktu</th> -->
              <th class="tengah text-center" style="border: 0;">Sabtu</th>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr>
              <th class="text-center" style="width: 50%">
                <?php echo @substr($hari_rentang['Sabtu'][$i]->jam_mulai,0,5)."-".@substr($hari_rentang['Sabtu'][$i]->jam_selesai,0,5); ?>
              </th>
              <td>
                <a class="btn btn-info" style="display: block;">Tambahkan</a>
              </td>
        ...
        <table class="table table-bordered table-striped tabelmapel tampilkan_" id="minggu">
          <thead>
            <tr class="barishari" style="background: #009688;color: white">
              <th class="tengah text-center" style="border: 0;">Jam</th>
              <!-- <th class="tengah" >Waktu</th> -->
              <th class="tengah text-center" style="border: 0;">Minggu</th>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            <tr>
              <th class="text-center" style="width: 50%">
                <?php echo @substr($hari_rentang['Minggu'][$i]->jam_mulai,0,5)."-".@substr($hari_rentang['Minggu'][$i]->jam_selesai,0,5); ?>
              </th>
              <td>
                <a class="btn btn-info" style="display: block;">Tambahkan</a>
              </td>
