...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo site_url('guru/profile');?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li ><a href="harirentang.php"><i class="fa fa-circle-o"></i> Penjadwalan</a>
            <ul class="treeview-menu">
              <li ><a href="<?php echo site_url('guru/jammengajar'); ?>"><i class="fa fa-circle-o text-red"></i> Jam Mengajar Guru</a></li>
              <li ><a  href="<?php echo site_url('guru/jadwalmapel');?>"><i class="fa fa-circle-o text-red"></i> Jadwal Mapel</a></li>
              <li ><a  href="<?php echo site_url('guru/jadwalpiketguru');?>"><i class="fa fa-circle-o text-red"></i> Jadwal Piket Guru</a></li>
              <li ><a href="<?php echo site_url('guru/jadwaltambahan');?>"><i class="fa fa-circle-o text-red"></i> Jadwal Tambahan</a></li>
            </ul>
          </li>
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
       <li><a href="<?php echo site_url('guru/gantipassword');?>">Ganti Password</a></li> 
    </ul> 
  </li>
...
<!-- /.sidebar -->
  ...
  <!-- <script src="<?php echo base_url();?>assets/admin/bootstrap/js/jquery-ui.min.js"></script> -->
