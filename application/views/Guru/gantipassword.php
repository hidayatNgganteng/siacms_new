                ...
                <form class="form-horizontal formmapel" method="post" action="<?php echo site_url('guru/updatepassword'); ?>">
                  ...
                  <div class="box-mapel" style="padding: 2% 0">
                      ...
                      <div class="form-group formgrup jarakform">
                        ...
                        <div class="col-sm-4">
                          <input type="password" class="form-control" name="password" required="required" placeholder="Password Lama ">
                        </div>
                      </div>
                      ...
                      <div class="form-group formgrup jarakform">
                        ...
                        <div class="col-sm-4">
                          <input type="password" class="form-control" name="passwordbaru"  required="required" placeholder="Password Baru ">
                        </div>
                      </div>
                      ...
                      <div class="form-group formgrup jarakform">
                        ...
                        <div class="col-sm-4">
                          <input type="password" class="form-control" name="confirmpassword" required="required" placeholder="Confirm Password ">
                        </div>
                      </div>
