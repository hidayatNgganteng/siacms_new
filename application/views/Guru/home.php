  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/superadmin/homeplugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>guru"><i class="fa fa-dashboard"></i> Home</a></li>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="<?php echo base_url();?>guru/homedatapegawai" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url();?>guru/homedataguru" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="#" class="small-box-footer">More info <i classs="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
       ...
       <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#grafik" data-toggle="tab">Column</a></li>
              <li><a href="#persentase" data-toggle="tab">Donut</a></li>
              <li class="pull-left header"><i class="fa fa-bar-chart"></i>Kehadiran Pegawai</li>
            </ul>
