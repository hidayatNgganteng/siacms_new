         ...
         <th abbr="Sunday" scope="col" title="Sunday">M</th>
          ...
          <tbody>
            ...
            for ($i=1; $i<=$jmlhari;$i++)
            {
             ...
             ?>
             <td onClick="<?php echo $clk; ?>" style="background-size: cover; <?php echo $cur; ?>" <?php if (@$simbol[ltrim($y,'0')][ltrim($m,'0')][$i] != "") { ?>background="<?php echo base_url(); ?>assets/penilaian/simbol/<?php echo @$simbol[ltrim($y,'0')][ltrim($m,'0')][$i]; ?>"<?php } ?>><font color="<?php echo $warna; ?>"><div align="center" class="style1">&nbsp;<?php echo $i;//." ".@$simbol[$y][$m][$i]; //." ".$m." ".$y; ?>&nbsp; <?php /*if (@$simbol[ltrim($y,'0')][ltrim($m,'0')][$i] != "") { ?><img src="<?php echo base_url(); ?>assets/simbol/<?php echo @$simbol[ltrim($y,'0')][ltrim($m,'0')][$i]; ?>" width="10"/><?php } */?></div></font></td>
             <?php
             if ($kolom=='7')
             {
              echo '</tr><tr>';
