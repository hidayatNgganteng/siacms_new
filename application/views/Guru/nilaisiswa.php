    ...
    <div class="row">
      ...
      <div class="col-md-12">
            ...
            <div class=" tab-pane" id="tambah_nilai">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <form method="post" action="<?php echo base_url('guru/tambah_nilai'); ?>" onsubmit="return ceknilai();">
                    <select id="pilihkelastambah" onchange="document.location='<?php echo site_url('guru/nilaisiswa'); ?>/'+document.getElementById('pilihkelastambah').value+'/'+document.getElementById('pilihmapeltambah').value;">
                    ...
                    <select name="mapel" id="pilihmapeltambah" onchange="document.location='<?php echo site_url('guru/nilaisiswa'); ?>/'+document.getElementById('pilihkelastambah').value+'/'+document.getElementById('pilihmapeltambah').value;">
                ...
                <button type="button" class="pull-right btn-jdwl" onclick="document.location='<?php echo site_url('guru/exportnilai/'.@$this->uri->segment(3).'/'.@$this->uri->segment(4)); ?>/'+document.getElementById('katnilai').value+'/'+document.getElementById('jenis_na').value;">Export</button>
        ...
        <div class="tab-pane" id="impornilai">
         <form class="form-horizontal formmapel" action="<?php echo base_url('guru/importnilai'); ?>" method="post" enctype="multipart/form-data">
          <div class="bigbox-mapel"> 
            <div class="box-mapel">
                  ...
                  <div class="col-md-12">
                    ...
                    <select nama="id_kelas_reguler_berjalan2" id="imporkelasnilai" onchange="document.location='<?php echo site_url('guru/nilaisiswa'); ?>/'+document.getElementById('imporkelasnilai').value+'/'+document.getElementById('impormapel').value;">
                      <option value="">Pilih Kelas</option>
                      <?php
                    ...
                    <select name="id_mapel2" id="impormapel" onchange="document.location='<?php echo site_url('guru/nilaisiswa'); ?>/'+document.getElementById('imporkelasnilai').value+'/'+document.getElementById('impormapel').value;">
            ...
            <div class="active tab-pane" id="daftar">
              ...
              <select id="pilihkelasnilai" onchange="document.location='<?php echo site_url('guru/nilaisiswa'); ?>/'+document.getElementById('pilihkelasnilai').value+'/'+document.getElementById('pilihmapelnilai').value;">
                <option value="">Pilih Kelas</option>
                <?php
              ...
              <select id="pilihmapelnilai" onchange="document.location='<?php echo site_url('guru/nilaisiswa'); ?>/'+document.getElementById('pilihkelasnilai').value+'/'+document.getElementById('pilihmapelnilai').value;">
                <option value="" >Pilih Mapel</option>
                <?php
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        foreach($nilai_siswa as $f){
                          ...
                          if (($this->session->userdata("jabatan") == "Kurikulum") || ($this->session->userdata("jabatan") == "Guru")) {
                            ?>
                            <a data-toggle="modal" data-show="true" data-target="#nilai<?php echo $no; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("guru/form_edit_nilai/".$f->id_nilai_siswa); ?>" >Edit</a>
                            <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("guru/hapus_nilai/".$f->id_nilai_siswa); ?>" onclick="return confirm_delete();">Hapus
                              <?php
                            }
                            ?>
                            <?php
               ...
               <div class="tab-pane" id="leger">
                <div class="box">
                 ...
                 <div class="box-body">
                  <option value=""></option>
                  <select id="pilihkelasledger" onchange="document.location='<?php echo site_url('guru/nilaisiswa'); ?>/'+document.getElementById('pilihkelasledger').value;">
                    <?php
                    foreach ($kelas_reguler_berjalan as $d){
                      ?>
