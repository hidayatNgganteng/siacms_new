            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo site_url('gurupiketpiket/profile');?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
        ...
        <ul class="sidebar-menu">
          ...
          if (in_array("1", $arrmenuakses)) {
                  ...
                  <li ><a href="#"><i class="fa fa-circle-o"></i> Penerimaan Peserta Didik Baru </a>
                   <ul class="treeview-menu">
                    ...
                    if (in_array("3", $arrmenuakses)) {
                      ?>
                      <li ><a href="<?php echo base_url();?>gurupiket/ppdbujian"><i class="fa fa-circle-o text-red"></i> PPDB Ujian</a></li>
                      <?php
                    }
                    ?>
                    ...
                    if (in_array("4", $arrmenuakses)) {
                      ?>
                      <li ><a href="<?php echo base_url();?>gurupiket/ppdbneg"><i class="fa fa-circle-o text-red"></i> PPDB UN</a></li>
                      <?php
                    }
                    ?>
                  </ul>
                ...
                <li ><a href="#"><i class="fa fa-circle-o"></i> Daftar Ulang </a> 
                 <ul class="treeview-menu">
                  ...
                  if (in_array("6", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>gurupiket/daftarulang"><i class="fa fa-circle-o text-red"></i>Peserta Didik Baru</a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("7", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>gurupiket/daftarkenaikan"><i class="fa fa-circle-o text-red"></i>Kenaikan Kelas</a></li>
                    <?php
                  }
                  ?>
                </ul>
              ...
              <li><a href="#"><i class="fa fa-circle-o"></i> Distribusi Kelas </a>
                <ul class="treeview-menu">
                  ...
                  if (in_array("9", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo site_url('gurupiket/distribusi_reg');?>"><i class="fa fa-circle-o text-red"></i> Kelas Reguler </a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("10", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo site_url('gurupiket/distribusi_tam');?>"><i class="fa fa-circle-o text-red"></i> Kelas Tambahan </a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("11", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>gurupiket/klinik_un"><i class="fa fa-circle-o text-red"></i> Klinik UN</a></li>
                    <?php
                  }
                  ?>
                </ul>
              ...
              <li><a href="#"><i class="fa fa-circle-o"></i> Mutasi </a>
                <ul class="treeview-menu">
                  ...
                  if (in_array("13", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>gurupiket/mutasi_masuk"><i class="fa fa-circle-o text-red"></i> Mutasi Masuk</a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("14", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>gurupiket/mutasi_keluar"><i class="fa fa-circle-o text-red"></i> Mutasi Keluar</a></li>
                    <?php
                  }
                  ?>
                </ul>
            ...
            if (in_array("15", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>gurupiket/bukuinduk"><i class="fa fa-circle-o"></i>Buku Induk</a></li>
              <?php
            }
            ?>
              ...
              <li ><a href="#"><i class="fa fa-circle-o"></i> Penjadwalan</a>
               <ul class="treeview-menu">
                ...
                if (in_array("18", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('gurupiket/namamapel'); ?>"><i class="fa fa-circle-o text-red"></i> Tambah Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("19", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('gurupiket/mapel'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("20", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('gurupiket/harirentang'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Hari & Jam</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("21", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('gurupiket/jammengajar'); ?>"><i class="fa fa-circle-o text-red"></i> Jam Mengajar Guru</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("22", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('gurupiket/jadwalmapel'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("23", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('gurupiket/jadwalpiketguru'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Piket Guru</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("24", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('gurupiket/jadwaltambahan'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Tambahan</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("25", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('gurupiket/Ekstrakurikuler'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Ekstrakurikuler</a></li>
                  <?php
                }
                ?>
            ...
            <li ><a href="#"><i class="fa fa-circle-o"></i> Penilaian</a>
             <ul class="treeview-menu">
              ...
              if (in_array("27", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>gurupiket/kaldik"><i class="fa fa-circle-o text-red"></i> KALDIK</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("28", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>gurupiket/kurikulum"><i class="fa fa-circle-o text-red"></i> Kurikulum Sekolah</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("29", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>gurupiket/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Presensi Siswa</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("30", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>gurupiket/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Nilai Siswa</a></li>  
                <?php
              }
              ?>
              ...
              if (in_array("31", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>gurupiket/kategorinilai"><i class="fa fa-circle-o text-red"></i> Kategori Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("32", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>gurupiket/jenisnilaiakhir"><i class="fa fa-circle-o text-red"></i> Jenis Nilai Akhir</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("33", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>gurupiket/deskripsinilai"><i class="fa fa-circle-o text-red"></i> Deskripsi Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("34", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>gurupiket/rapor"><i class="fa fa-circle-o text-red"></i> Rapor</a></li>
                <?php
              }
              ?>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        if (in_array("36", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('gurupiket/pegawaibaru');?>"><i class="fa fa-circle-o"></i>Data Pegawai</a></li>
          <?php
        }
        ?>
        ...
        if (in_array("37", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('gurupiket/presensipegawai');?>"><i class="fa fa-circle-o"></i>Presensi Pegawai</a></li>
          <?php
        }
        ?>
          ...
          <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
            <ul class="treeview-menu">
              ...
              if (in_array("40", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>gurupiket/pendaftaran"><i class="fa fa-circle-o text-red"></i>Pendaftaran</a></li>
                <?php
                }
                ?>
                ...
                if (in_array("41", $arrmenuakses)) {
                  ?>
                  <li><a href="<?php echo base_url();?>gurupiket/jadwal"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("42", $arrmenuakses)) {
                  ?>
                  <li><a href="<?php echo base_url();?>gurupiket/presensi"><i class="fa fa-circle-o text-red"></i> Presensi</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("43", $arrmenuakses)) {
                  ?>
                  <li><a href="<?php echo base_url();?>gurupiket/nilai"><i class="fa fa-circle-o text-red"></i> Nilai</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("44", $arrmenuakses)) {
                  ?>
                  <li><a href="<?php echo base_url();?>gurupiket/pembayaran"><i class="fa fa-circle-o text-red"></i> Pendanaan</a></li>
                  <?php
                }
                ?>
           ...
           <ul class="treeview-menu">
            ...
            <?php 
                if (in_array("46", $arrmenuakses)) {
                  ?>
             <li ><a href="<?php echo base_url();?>gurupiket/keterlambatan"><i class="fa fa-circle-o text-red"></i> Keterlambatan & Jam</a></li>
             <?php 
          }
          ?>
             ...
             <?php 
                if (in_array("47", $arrmenuakses)) {
                  ?>
             <li><a href="<?php echo base_url();?>gurupiket/absensi_harian"><i class="fa fa-circle-o text-red"></i> Perizinan</a></li>
             <?php 
          }
          ?>
             ...
             <?php 
                if (in_array("48", $arrmenuakses)) {
                  ?>
             <li><a href="<?php echo base_url();?>gurupiket/pelanggaran"><i class="fa fa-circle-o text-red"></i> Pelanggaran</a></li>
             <?php 
          }
          ?>
             ...
             <?php 
                if (in_array("49", $arrmenuakses)) {
                  ?>
             <li><a href="<?php echo base_url();?>gurupiket/prestasi"><i class="fa fa-circle-o text-red"></i> Prestasi</a></li>
             <?php 
          }
          ?>
           </ul>
...
<li class="treeview">
  <a href="<?php echo site_url('gurupiket/rekapkehadiran');?>">
    <i class="fa fa-circle-o text-aqua"></i> <span>Rekap Kehadiran Pribadi</span>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo site_url('gurupiketpiket/gantipassword');?>">Ganti Password</a></li> 
            </ul> 
          </li>
        </ul>
