...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo site_url('gurupiket');?>">Dashboard</a></li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
           <?php
           if (($this->session->userdata('jabatan') == 'Admin') || ($this->session->userdata('jabatan') == 'Guru Piket')) {
            ?>
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <div style="overflow: auto">
                  <form action="<?php echo site_url('gurupiket/submitpresensipegawai'); ?>" method="post" accept-charset="utf-8">
