      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="<?php echo site_url('karyawan/jadwalmapel');?>">
                <i class="fa fa-circle-o text-aqua"></i> <span>Jadwal Mapel</span>
              </a>
            </li>

            <li class="treeview">
              <a href="<?php echo site_url('karyawan/jadwalpiketguru');?>">
                <i class="fa fa-circle-o text-aqua"></i> <span>Jadwal Piket Guru</span>
              </a>
            </li>

            <li class="treeview">
              <a href="<?php echo site_url('karyawan/jadwaltambahan');?>">
                <i class="fa fa-circle-o text-aqua"></i> <span>Jadwal Tambahan</span>
              </a>
            </li>
            <br>

            <li class="header">MENU KEPEGAWAIAN</li>
            <li class="treeview">
              <a href="<?php echo site_url('karyawan/presensipegawai');?>">
                <i class="fa fa-circle-o text-aqua"></i> <span>Presensi Pegawai</span>
              </a>
            </li>

            <li class="treeview">
              <a href="<?php echo site_url('karyawan/jadwalmengajar');?>">
                <i class="fa fa-circle-o text-aqua"></i> <span>Jadwal Mengajar</span>
              </a>
            </li>
            <br>
