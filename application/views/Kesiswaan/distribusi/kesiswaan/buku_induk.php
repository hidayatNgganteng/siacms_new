          ...
          <tbody class="searchable">
            ...
            foreach ($tabel_siswa as $row) {
              ...
              <tr>
                ...
                <td>                        
                  <a data-toggle="modal" class="btn btn-default btn-xs" data-show="true" href="<?php echo site_url('distribusi/kesiswaan/edit_buku_induk_siswa/'.$row->nisn); ?>" data-target="#mySiswa<?php echo $i; ?>"><i class="fa fa-pencil text-red" aria-hidden="true"></i> Siswa</a>
                  <a data-toggle="modal" class="btn btn-default btn-xs" data-show="true" href="<?php echo site_url('distribusi/kesiswaan/edit_buku_induk_ortu/'.$row->nisn); ?>" data-target="#myOrtu<?php echo $i; ?>"><i class="fa fa-pencil text-blue" aria-hidden="true"></i> Orang Tua</a>               
                </td>
              </tr>
              <?php
              $i=$i+1;
