    ...
    <div class="modal-dialog">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Edit Informasi Siswa : <?php echo $row_siswa->nama; ?></h4><br>
      </div>
      <div class="modal-content">
        <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('distribusi/kesiswaan/update_buku_induk_siswa/'.$row_siswa->nisn); ?>" enctype="multipart/form-data"><br>    
          ...
          <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="radio" name="jenis_kelamin" required="required"
                  <?php if (isset($row_siswa->jenis_kelamin) && $row_siswa->jenis_kelamin=="Perempuan") echo "checked";?> value="Perempuan">Perempuan <br>
                 <input type="radio" required="required" name="jenis_kelamin" 
                    <?php if (isset($row_siswa->jenis_kelamin) && $row_siswa->jenis_kelamin=="Laki-Laki") echo "checked";?> value="Laki-laki">Laki-Laki 
              </div> 
          </div>
          <div class="form-group">
      ...
      <div class="form-group">
        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Kategori Penduduk</label>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="radio" name="kategori_penduduk" <?php if (isset($row_siswa->kategori_penduduk) && $row_siswa->kategori_penduduk=="Dalam Daerah") echo "checked";?> value="Dalam Daerah"> Dalam Daerah <br>
            <input type="radio" name="kategori_penduduk" <?php if (isset($row_siswa->kategori_penduduk) && $row_siswa->kategori_penduduk=="Luar Daerah") echo "checked";?> value="Luar Daerah"> Luar Daerah 
          </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Asal Mutasi</label>
         <div class="col-md-6 col-sm-6 col-xs-12">
           <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" placeholder=" apabila siswa pindahan" name="asal_sekolah" value="<?php echo $row_siswa->asal_sekolah; ?>">
          </div>
      </div>
      <div class="form-group">
        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Pernah PAUD</label>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="radio" name="pernah_paud" <?php if (isset($row_siswa->pernah_paud) && $row_siswa->pernah_paud=="Ya") echo "checked";?> value="Ya"> Ya <br>
            <input type="radio" name="pernah_paud" <?php if (isset($row_siswa->pernah_paud) && $row_siswa->pernah_paud=="Tidak") echo "checked";?> value="Tidak"> Tidak 
          </div>
      </div>
      <div class="form-group">
        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Pernah TK</label>
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="radio" name="pernah_tk" <?php if (isset($row_siswa->pernah_tk) && $row_siswa->pernah_tk=="Tidak") echo "checked";?> value="Tidak"> Tidak 
          </div>
      </div>
      <div class="form-group">
