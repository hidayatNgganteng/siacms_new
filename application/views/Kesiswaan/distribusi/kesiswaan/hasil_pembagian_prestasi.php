<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="tab-pane" id="kelas">
                    ...
                    <h3 class="box-title" style="color : white">Kelas 7A</h3>
                  </div>
                    ...
                    <table class="table table-striped projects">
                      <thead>
                        <tr>
                          ...
                          <th class="center">Peringkat Prestasi</th>
                  ...
                  <ul class="pagination pagination-sm no-margin pull-right">
                    ...
                    <li class="active"><a href="<?php echo base_url();?>distribusi/kesiswaan/hasil_pembagian_prestasi">1</a></li>
                    <li><a href="#">2</a></li>
                    <li><a href="#">3</a></li>
