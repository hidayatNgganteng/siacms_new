            ...
            <tbody>
              ...
              <tr class="odd gradeX">
                ...
                <td><?php echo $m->status_req; ?></td>
                  ...
                  if ($m->respon == "") {
                    ?>
                    <form id="form<?php echo $m->id_klinik_un; ?>" method="post" action="<?php echo site_url("kesiswaan/simpan_respon/".$m->id_klinik_un); ?>">
                    <td>
                  ...
                  <td>&nbsp;</td>
                  <td>
                    <a onclick="return confirm"('Apakah anda yakin akan menghapus data? <?php echo $m->id_klinik_un; ?>') href="<?php echo site_url("kesiswaan/hapus_klinik_un/".$m->id_klinik_un) ?>" type="button" role="button" class="btn btn-danger">Hapus</a>
                  </td>
                  <?php
                }
                ?>
