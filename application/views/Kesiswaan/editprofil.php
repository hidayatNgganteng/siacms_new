  ...
  <section class="content">
      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-pane" id="editdatpeg">
            <form class="form-horizontal formmapel" method="post" action="<?php echo site_url('kesiswaan/editprofil/'.$rowpeg->NIP); ?>" enctype="multipart/form-data">
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-5">
      ...
      <a href="<?php echo site_url('kesiswaan/profile');?>" type="button" role="button" class="btn btn-danger">Cancel</a>
    </div>
  </div>
</form>
