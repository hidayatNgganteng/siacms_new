...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">       
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('ppdb/admin/daftarulang_ppdb/updateberkas/'.$row_pendaftar_daftarulang_ppdb->nisn); ?>">
