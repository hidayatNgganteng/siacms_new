                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                               <!--  <li class="active"><a href="http://localhost/sia2kep2/ppdb/calon_siswa/form_ppdb">PPDB</a></li> -->
                               <li class="active"><a href="<?php echo site_url('ppdb/calon_siswa/frontend_ppdb');?>">PPDB</a></li> 
                                <!-- <li><a href="http://localhost:8000/sia/distribusi/sekolah/mutasi">Mutasi</a></li> -->
                                <li><a href="<?php echo site_url('distribusi/sekolah/mutasi');?>">Mutasi</a></li>
                            </ul>
                        </li>                    
                        <div class="search">
                                <form role="form">
