...
<aside class="main-sidebar">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li ><a href="<?php echo base_url();?>distribusi/siswa/klinik_un_siswa"><i class="fa fa-circle-o"></i>Klinik UN</a>
        </li>
        </ul>
      </li>
      <li class="treeview">
        <a href="<?php echo base_url();?>ppdb/siswa/setting_akun_siswa">
