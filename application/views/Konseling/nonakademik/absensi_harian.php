         ...
         <div class="col-md-12">
           <div class="box">
             <div class="box-header with-border">
               ...
               <form method="post" action="<?php echo site_url('konseling/Perizinan'); ?>">
                 <?php
                   $tgl = date('Y-m-d');
              ...
              <table class="table table-bordered">
                ...
                foreach ($absenharian as $rowabsenharian) {
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo site_url('konseling/deleteperizinan/'.$rowabsenharian->id_absen_harian); ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin?');">Del</a></td>
                  </tr>
                  <?php
                    }
                  ?>
