                    ...
                    <ul class="nav nav-tabs pull-left">
                      ...
                      <br/><br/><br/><br/>
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                  <select id="thn" name="tahun" onchange="document.location = '<?php echo site_url('konseling/grafik'); ?>/'+document.getElementById('thn').value;">
...
<script src="<?php echo base_url(); ?>assets/nonakademik/highcharts/code/highcharts.js"></script>
<script src="<?php echo base_url(); ?>assets/nonakademik/highcharts/code/modules/exporting.js"></script>
