                ...
                <div class="tab-content no-padding">
                  <div class="chart tab-pane active" id="tab1" style="position: relative; ">
                      ...
                      <div class="box">
                        ...
                        <div class="box-body">
                          <select name="id_kelas_reguler1" id="id_kelas_reguler1" onchange="document.location = '<?php echo site_url('nonakademik/nilai'); ?>'+'/'+document.getElementById('id_kelas_reguler1').value;">
                             <option value="">...</option>
                            <?php
                             ...
                             <td>
                              <?php
                                if ($row->jenis_kls_tambahan != "") {
                                  ?>
                                  <input type="text" name="nilai_<?php echo $row->nisn; ?>_<?php echo $row->id_jenis_kls_tambahan; ?>" value="<?php echo @$row->nilai_ekskul; ?>"/>
                                  <!--input type="radio" name="nilai_<?php //echo $row->nisn; ?>_<?php //echo $row->id_jenis_kls_tambahan; ?>" value="A"/>&nbsp; A &nbsp;
                                  <input type="radio" name="nilai_<?php //echo $row->nisn; ?>_<?php //echo $row->id_jenis_kls_tambahan; ?>" value="B"/>&nbsp; B &nbsp;
                                  <input type="radio" name="nilai_<?php //echo $row->nisn; ?>_<?php //echo $row->id_jenis_kls_tambahan; ?>" value="C"/>&nbsp; C &nbsp;-->
                                <?php
                                  } else {
                                  ?>
                                  &nbsp;
                  ...
                  <div class="chart tab-pane" id="tab2" style="position: relative; ">
                       <div class="box">
                        ...
                        <select name="Semester">
                          ...
                          <select name="id_kelas_reguler2" id="id_kelas_reguler2" onchange="document.location = '<?php echo site_url('nonakademik/nilai'); ?>'+'/'+document.getElementById('id_kelas_reguler2').value;">
                             <option value="">...</option>
                            <?php
                            foreach ($kelas_reguler as $row) {
                            ?>
