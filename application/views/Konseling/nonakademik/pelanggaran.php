                ...
                <div class="box">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                              ...
                              <td><a href="<?php echo site_url('konseling/deletepelanggaran/'.$rowpelanggaran->id_jenis_pelanggaran); ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin?');">Del</a></td>
                            <?php
                            }
                            ?>
                          </table>
