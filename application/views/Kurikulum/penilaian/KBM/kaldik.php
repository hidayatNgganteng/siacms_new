            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                   ...
                   <div class="box">
                    <div class="box-header jarakbox">
                      ...
                      for ($o=0; $o<(count($kaldik)/5)  ; $o++) { 
                        ...
                        while ($p < (5*($o+1))) {
                          if(!empty($kaldik[$p])) echo '<img src="'.base_url().'assets/penilaian/simbol/'.$kaldik[$p]->simbol_kaldik.'" height="70" width="70"/> '.$kaldik[$p]->nama_kaldik.'<br/>';
                          $p++;
                        }
                        echo "</div>";
                      ...
                      ?>
                      <div class="col-md-12">
                        <a class="pull-right" href="<?php echo site_url('penilaian/cetak/printkaldik'); ?>" ><button class="btnjdwl"><i class="fa fa-upload text-red "></i> Print</button></a>
                      </div>  
                    </div>
                ...
                <div class="tab-pane" id="tambahkaldik">
                 <form class="form-horizontal formkaldik" action="<?php echo site_url('kurikulum/tambah_kaldik'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <tbody>
                      ...
                      foreach ($kaldik as $rowkaldik) {
                        ...
                        <tr>
                          ...
                          <td> 
                            <a data-toggle="modal" data-show="true" data-target="#editkaldik<?php echo $i; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("kurikulum/form_edit_kaldik/".$rowkaldik->id_kaldik); ?>" >Edit</a>
                            <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("/kurikulum/hapus_kaldik/".$rowkaldik->id_kaldik); ?>" onclick="return confirm_delete();">Hapus</a>
                          </td>               
                        </tr>
