      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
              ...
              <div class="box-header jarakbox">
                <?php
                  foreach ($kurikulum as $rowkur) {
                    # code...
                  ?>
                <center><embed src="<?php echo base_url();?>assets/penilaian/dokumen_kurikulum/<?php echo $rowkur->nama_filekur ?>" width="1000" height="1000"> </embed></center>
                <?php
              }
              ?>
              </div>
          ...
          <div class="tab-pane" id="tambahkurikulum">
           <form class="form-horizontal formkaldik" action="<?php echo base_url('/kurikulum/tambah_kurikulum'); ?>" method="post" enctype="multipart/form-data" novalidate>
            ...
            <tbody>
              ...
              foreach ($kurikulum as $rowkur) {
                ...
                <tr>
                  ...
                  <td> 
                    <a data-toggle="modal" data-show="true" data-target="#editkur<?php echo $i; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("kurikulum/form_edit_kurikulum/".$rowkur->id_kurikulum); ?>" >Edit</a>
                    <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("/kurikulum/hapus_kurikulum/".$rowkur->id_kurikulum); ?>" onclick="return confirm_delete();">Hapus</a>
                  </td>               
                </tr>
