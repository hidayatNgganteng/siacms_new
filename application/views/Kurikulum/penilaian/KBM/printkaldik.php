...
function drawCal($bln, $thn, $simbol) {
 ...
 $nm=date('F');
      ...
      ?>
                          ...
                          <?php
                          drawCal(1, 2018, $simbol);
                          ?>
                          <br/>
                         <?php
                          drawCal(2, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(3, 2018, $simbol);
                          ?>
                       <br/>
                          <?php
                          drawCal(4, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(5, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(6, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(7, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(8, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(9, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(10, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(11, 2018, $simbol);
                          ?>
                        <br/>
                          <?php
                          drawCal(12, 2018, $simbol);
                          ?>
 <?php
                      // echo "<pre>";
                      // print_r($kaldik);
                      ...
                      for ($o=0; $o<(count($kaldik)/5)  ; $o++) { 
                        ...
                        while ($p < (5*($o+1))) {
                          if(!empty($kaldik[$p])) echo '<img src="'.base_url().'penilaian/assets/simbol/'.$kaldik[$p]->simbol_kaldik.'" height="70" width="70"/> '.$kaldik[$p]->nama_kaldik.'<br/>';
                          $p++;
                        }
                        echo "</div>";
