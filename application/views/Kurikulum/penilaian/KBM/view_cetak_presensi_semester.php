...
for ($i=1;$i<=2;$i++) {
 ...
 ?>
  ...
  width:48pt'><?php echo $datpresensisemester[$rowsiswa->nisn][$i]['S']; ?></td>
  <td class=xl6314515 width=64 style='border-top:none;border-left:none;
  width:48pt'><?php echo $datpresensisemester[$rowsiswa->nisn][$i]['I']; ?></td>
  <td class=xl6314515 width=64 style='border-top:none;border-left:none;
  width:48pt'><?php echo $datpresensisemester[$rowsiswa->nisn][$i]['A']; ?></td>
 </tr>
 <?php
 	}
 }
