...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center style="color:navy;">Manajemen waktu untuk Jadwal Mata Pelajaran SMP Yogyakarta <br></center>
...
<script type="text/javascript">
  $(document).ready(function() {
      ...
      var box_mapel       = `<div class="box-mapel">
                              ...
                              <i class="fa fa-minus-circle text-red tambahmapel"></i><a style="color:red" href="#" class="remove_field"> Hapus waktu</a>
