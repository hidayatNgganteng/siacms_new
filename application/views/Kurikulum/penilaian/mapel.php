...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li clas="active"><a href="mapel.php"><i class="fa fa-circle-o text-red"></i> <span>Mata Pelajaran</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center style="color:grey;">Halaman Kelola Data Mata Pelajaran SMP Yogyakarta <br></center>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#kelolamapel" data-toggle="tab">Tambah Mata Pelajaran</a></li>
            ...
            <div class="tab-content">
                    ...
                    <div class="box-mapel">
                      <div class="form-group formgrup jarakform">
                        ...
                        <div class="col-sm-4">
                          <form action="">
                              <div class="col-sm-6">
                              <input type="radio" name="inputName" value="P.AGAMA"> PENDIDIKAN AGAMA<br> 
                              <input type="radio" name="inputName" value="PPKN"> PPKN<br>
                              <input type="radio" name="inputName" value="B.INDO"> B.INDO<br>
                              <input type="radio" name="inputName" value="MATEMATIKA"> MATEMATIKA<br>
                              <input type="radio" name="inputName" value="IPA"> IPA<br>
                              </div>
                              <div class="col-sm-6">
                              <input type="radio" name="inputName" value="IPS"> IPS<br>  
                              <input type="radio" name="inputName" value="B.INGGRIS"> B.INGGRIS<br>
                              <input type="radio" name="inputName" value="SBK"> SENI BUDAYA<br>
                              <input type="radio" name="inputName" value="PENJASKES"> PENJASKES<br>
                              <input type="radio" name="inputName" value="PRAKARYA"> PRAKARYA<br>
                              </div>
              ...
              <!-- DATA MAPEL KELAS 7 -->
                <div class="box">
                  <div class="box-header" style="background-color:     #5c8a8a">
                    <h3 class="box-title" style="color:white">Data Mata Pelajaran Kelas 7</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td>7</td>
                        <td>70</td>
                        <td> <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button><button type="button" class="btn btn-block btn-primary button-action btnhapus">Hapus</button></td>               
                      </tr>
                      <tr>
                        <td class="fit">2</td>
                        <td>B.INDONESIA </td>
              ...
              <!-- DATA MAPEL KELAS 8 -->
                <div class="box">
                  <div class="box-header" style="background-color:   #75a3a3">
                    <h3 class="box-title" style="color : white">Data Mata Pelajaran Kelas 8</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
              ...
              <!-- DATA MAPEL KELAS 9 -->
                <div class="box">
                  <div class="box-header" style="background-color:   #94b8b8">
                    <h3 class="box-title" style="color : white">Data Mata Pelajaran Kelas 9</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td>5</td>
                        <td>50</td>
                        <td> <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel">Edit</button><button type="button" class="btn btn-block btn-primary button-action btnhapus">Hapus</button></td>               
                      </tr>
                      <tr>
                        <td class="fit">3</td>
                        <td>B.JAWA </td>
