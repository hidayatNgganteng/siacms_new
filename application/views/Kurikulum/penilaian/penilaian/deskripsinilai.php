        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="  tab-pane " id="tambahdeskripsi">
             <select id="pilihkelasdesktambah" onchange="document.location='<?php echo site_url('penilaian/penilaian/deskripsinilai'); ?>/'+document.getElementById('pilihkelasdesktambah').value+'/'+document.getElementById('pilihmapeldesktambah').value;">
                    ...
                    <select name="mapel" id="pilihmapeldesktambah" onchange="document.location='<?php echo site_url('penilaian/penilaian/nilaisiswa'); ?>/'+document.getElementById('pilihkelastambah').value+'/'+document.getElementById('pilihmapeltambah').value;">
            ...
            <form class="form-horizontal formmapel" method="post" action="<?php echo base_url('penilaian/penilaian/tambah_desknilai'); ?>" id="desknilai">
          ...
          <div class="tab-pane active" id="lihatdeskripsi">
           <select id="pilihkelasdesknilai" onchange="document.location='<?php echo site_url('penilaian/penilaian/deskripsinilai'); ?>/'+document.getElementById('pilihdekkelasnilai').value+'/'+document.getElementById('pilihmapeldesknilai').value;">
            <option value="" ></option>
            <?php
          ...
          <form class="">
            <select id="pilihmapeldesknilai" onchange="document.location='<?php echo site_url('penilaian/penilaian/deskripsinilai'); ?>/'+document.getElementById('pilihkelasdesknilai').value+'/'+document.getElementById('pilihmapeldesknilai').value;">
              <?php
              foreach ($mapel as $x){
                ?>
                <option value="<?php echo $x->id_mapel;?>" <?php if ($id_mapel == $x->id_mapel) { echo " selected"; } ?>><?php echo $x->nama_mapel; echo $x->jenjang?></option>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  foreach($deskripsi_nilai as $s){
                    ...
                    echo "<td>";
                    ?>
                    <a data-toggle="modal" data-show="true" data-target="#editdesknilai<?php echo $no; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("penilaian/penilaian/form_edit_deskripsi/".$s->id_deskripsi); ?>" >Edit</a>
                    <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("penilaian/penilaian/hapus_desknilai/".$s->id_deskripsi); ?>" onclick="return confirm_delete();">Hapus
                      <?php
                      echo "</tr>";
                      ?>
