    ...
    <div class="row" >
      <div class="col-md-12">
                    ...
                    <tbody>
                      ...
                      foreach ($tabel_jenisklstambahan as $row_jenisklstambahan) {
                        ...
                        <tr>
                          ...
                          <td class="text-center"><?php echo $row_jenisklstambahan->jenis_kls_tambahan; ?></td>
                        <?php
                          if($this->session->userdata('jabatan') == 'Ekskul') :
                        ?>
                          <td> 
        ...
        <?php endif ?>
          ...
          <div class="tab-pane <?php echo $this->session->flashdata('position_tab') == 3 ? 'active' : '' ?>" id="dataekstrakurikuler" style="padding: 1em;">
