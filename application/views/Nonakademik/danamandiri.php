         ...
         <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <form role="form" method="post" action="<?php echo site_url('nonakademik/simpanpembayaran'); ?>">
                  <?php
                      $tgl = date('Y-m-d');
                    ...
                    <table class="table table-bordered">
                      ...
                      foreach ($danamandiri as $rowdanamandiri) {
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('nonakademik/deletepembayaran/'.$rowdanamandiri->id_danamandiri); ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin?');">Del</a></td>
                          <?php
                        }
                        ?>
                      </table>
