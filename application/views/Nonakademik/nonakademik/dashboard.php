...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo site_url('nonakademik/dashboard');?>" class="logo">
                ...
                <li class="user-header">
                 <img src="<?php echo base_url();?>assets/superadmin/fotoguru/<?php echo $foto; ?>" class="img-circle" alt="User Image">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo site_url('nonakademik/profile');?>" class="btn btn-default btn-flat">Profile</a>
                    </div>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
                  <ul class="treeview-menu">
                    <li ><a href="<?php echo site_url('nonakademik/pendaftaran');?>"><i class="fa fa-circle-o text-red"></i> Pendaftaran</a></li>
                    <li><a href="<?php echo site_url('nonakademik/jadwal');?>"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
                    <li><a href="<?php echo site_url('nonakademik/presensi');?>"><i class="fa fa-circle-o text-red"></i> Presensi</a></li>
                    <li><a href="<?php echo site_url('nonakademik/nilai');?>"><i class="fa fa-circle-o text-red"></i> Penilaian</a></li>
                    <li><a href="<?php echo site_url('nonakademik/pembayaran');?>"><i class="fa fa-circle-o text-red"></i> Pendanaan</a></li>
                  </ul>
                </li>
              </ul>
              <ul class="treeview-menu">
                <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Konseling</a>
                  <ul class="treeview-menu">
                    <li ><a href="<?php echo site_url('nonakademik/keterlambatan');?>"><i class="fa fa-circle-o text-red"></i> Keterlambatan</a></li>
                    <li><a href="<?php echo site_url('nonakademik/perizinan');?>"><i class="fa fa-circle-o text-red"></i> Perizinan</a></li>
                    <li><a href="<?php echo site_url('nonakademik/pelanggaran');?>"><i class="fa fa-circle-o text-red"></i> Pelanggaran</a></li>
                    <li><a href="<?php echo site_url('nonakademik/prestasi');?>"><i class="fa fa-circle-o text-red"></i> Prestasi</a></li>
                  </ul>
                </li>
              </ul>
              <ul class="treeview-menu">
                <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Menu Kelola</a>
                  <ul class="treeview-menu">
                    <li ><a href="<?php echo site_url('nonakademik/tmbh_ekstrakurikuler');?>"><i class="fa fa-circle-o text-red"></i> Menambah Ekstrakurikuler</a></li>
                    <li><a href="<?php echo site_url('nonakademik/tmbh_pembimbing');?>"><i class="fa fa-circle-o text-red"></i> Menambah Pembimbing</a></li>
                    <li><a href="<?php echo site_url('nonakademik/tmbh_pelanggaran');?>"><i class="fa fa-circle-o text-red"></i> Menambah Pelanggaran</a></li>
                  </ul>
                </li>
              </ul>
            </li>  
...
<script src="<?php echo base_url("assets/tema/dist/js/demo.js") ?>"></script>
<script src="<?php echo base_url("assets/tema/plugins/flot/jquery.flot.min.js") ?>"></script>
<script src="<?php echo base_url("assets/tema/plugins/flot/jquery.flot.resize.min.js") ?>"></script>
<script src="<?php echo base_url("assets/tema/plugins/flot/jquery.flot.categories.min.js") ?>"></script>
