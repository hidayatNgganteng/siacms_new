	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box-body">
				<form name="daftar_ekskul" id="daftar_ekskul" method="post" action="<?php echo site_url("nonakademik/pendaftaran/simpan") ?>">
					<div class="col-md-4">
						<div class="box-body">
					...
					<table class="table table-bordered">
	                    ...
	                    <?php foreach ($statistik_ekskul as $eks) : ?>
	                    	...
	                    	<tr>
		                      ...
		                      <td><a data-toggle="modal" data-show="true" href="<?php echo site_url('nonakademik/datapeserta/'.$eks->id_jenis_kls_tambahan); ?>" data-target="#myModal<?php echo $eks->id_jenis_kls_tambahan ?>"><?php echo $eks->jumlah ?></a></td>
		                    </tr>
...
<script>
	$(function () {
		$("#btn-cari").click(function(){
			var nisn = $("#nisn").val();
			$.post( "<?php echo site_url("nonakademik/pendaftaran/get_siswa") ?>", {nis: nisn}, function( data ) {
				if (data != "")
				{
		...
		$("#daftar_ekskul").submit(function(){
			...
			if (jumcek > 3)
			{
				alert("Pilihan Ekskul tidak boleh lebih dari 3.");
				return false;
			}
