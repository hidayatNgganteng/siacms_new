                ...
                <div role="tabpanel" data-example-id="togglable-tabs">
                  <div id="detailspegawai" class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="kode_guru"  class="form-control col-md-7 col-xs-12"  value="<?php echo $datpeg->kode_guru;?>" readonly>
                      </div>
                     <!--  <br><br>
...
<br><br>
<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nomorayah">Kontak</label>
<div class="col-md-6 col-sm-6 col-xs-12">
...
<br><br>
<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nomoribu">Kontak</label>
<div class="col-md-6 col-sm-6 col-xs-12">
