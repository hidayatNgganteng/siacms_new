          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url();?>assets/admin/fotosiswa/<?php echo $foto; ?>" class="user-image" alt="User Image">
...
<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url();?>siswa/siswa_mutasi"><i class="fa fa-circle-o"></i>Siswa Mutasi</a></li>
                <li><a href="<?php echo base_url();?>siswa/daftarulang_kenaikan_siswa"><i class="fa fa-circle-o"></i>Daftar Kelas</a></li>
              </ul>
            </li>
           </ul>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li ><a href="<?php echo base_url();?>siswa/klinik_un_siswa"><i class="fa fa-circle-o"></i>Klinik UN </a></li>
      </li>
