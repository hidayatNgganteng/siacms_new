                      ...
                      for($i=0;$i<=11;$i++)  {
                        ...
                        <tr>
                          ...
                          foreach (@$tabel_jammengajar as $rowjammengajar) {
                            ...
                            if ($ada == false) {
                              if ((@$tabel_jadwalmapel_senin[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_senin[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo $rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")";
                            }
                          }
                        }
                        ?></td>
                        ...
                        <td class="putih">
                          ...
                          foreach (@$tabel_jadwalprioritas_selasa[$i] as $rowjadwalprioritas) {
                            ...
                            if ($ada == false) {
                              if ((@$tabel_jadwalmapel_selasa[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjadwalprioritas->NIP) && (@$tabel_jadwalmapel_selasa[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjadwalprioritas->id_namamapel)) { echo $rowjadwalprioritas->nama_mapel."(".$rowjadwalprioritas->nama_panggilan.")";
                            }
                          }
                        }
                        ?>
                        ...
                        foreach (@$tabel_jammengajar as $rowjammengajar) {
                          ...
                          if ($ada == false) {
                            if ((@$tabel_jadwalmapel_selasa[$row_siswa->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_selasa[$row_siswa->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo $rowjammengajar->nama_mapel."(".$rowjammengajar->nama_panggilan.")";
                          }
                        }
                      }
                      ?></td>
