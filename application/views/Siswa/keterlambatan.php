                    ...
                    <table class="table table-bordered">
                      ...
                      foreach ($keterlambatan as $row_keterlambatan) {
                        ...
                        <tr >
                          <td> Semester 1</td>
                          <td>
                            <a data-toggle="modal" data-show="true" href="<?php echo site_url('siswa/dataketerlambatan/'.$id_tahun_ajaran."/".$row_keterlambatan->orang); ?>" data-target="#myModal<?php echo $row_keterlambatan->orang ?>"><?php echo $row_keterlambatan->orang; ?> Siswa</a>
                          </td>
                          <td>
