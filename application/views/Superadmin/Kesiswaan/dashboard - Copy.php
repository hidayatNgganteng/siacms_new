      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li ><a href="#"><i class="fa fa-circle-o"></i> Penerimaan Peserta Didik Baru </a>
               <ul class="treeview-menu">
                <li ><a href="<?php echo base_url();?>kesiswaan/ppdbujian"><i class="fa fa-circle-o text-red"></i> PPDB Ujian</a></li>
                <li ><a href="<?php echo base_url();?>kesiswaan/ppdbneg"><i class="fa fa-circle-o text-red"></i> PPDB UN</a></li>
              </ul>
            </li>
          ...
          <li ><a href="#"><i class="fa fa-circle-o"></i> Distribusi Kelas </a>
            <ul class="treeview-menu">
              <li ><a href="<?php echo base_url();?>kesiswaan/distribusi_reg"><i class="fa fa-circle-o text-red"></i> Kelas Reguler </a></li>
              <li ><a href="<?php echo base_url();?>kesiswaan/distribusi_tam"><i class="fa fa-circle-o text-red"></i> Kelas Tambahan </a></li>
