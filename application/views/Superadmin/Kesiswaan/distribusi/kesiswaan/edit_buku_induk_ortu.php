  ...
  <body>
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('superadmin/kesiswaan/update_buku_induk_ortu/'.$row_siswa_ortu->id_orangtua); ?>"><br>
