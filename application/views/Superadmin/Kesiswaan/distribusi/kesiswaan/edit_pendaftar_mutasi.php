  ...
  <body>
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('superadmin/updatependaftar_mutasi/'.$tabel_siswa_mutasi_masuk->nisn_pendaftar_mutasi); ?>" ><br>
