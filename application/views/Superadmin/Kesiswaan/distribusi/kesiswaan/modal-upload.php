  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('superadmin/kesiswaan/data_import_prestasi'); ?>" enctype="multipart/form-data">
