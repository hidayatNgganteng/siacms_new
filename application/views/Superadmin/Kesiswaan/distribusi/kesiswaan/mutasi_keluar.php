  <div class="content-wrapper">
    ...
    <div class="col-md-12">
          <div class="nav-tabs-custom">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('superadmin/save_siswa_mutasi_keluar'); ?>" >
              ...
              <table class="table table-striped projects datatables">
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            <?php
                            $link_diterima = base_url()."superadmin/ubah_status_siswa_mutasi_keluar/".$row->id_siswa_mutasi_keluar."/Diterima";
                            $link_ditolak = base_url()."superadmin/ubah_status_siswa_mutasi_keluar/".$row->id_siswa_mutasi_keluar."/Ditolak";
                            $link_dicabut = base_url()."superadmin/ubah_status_siswa_mutasi_keluar/".$row->id_siswa_mutasi_keluar."/Dicabut";
                            ?>
                ...
                <tr>
                   ...
                   <td>
                     <a href="<?php echo site_url('superadmin/nonaktifkan_akun/').$row->nisn; ?>" class="btn btn-primary">Non Aktifkan Akun</a>
                   </td>
                   <td>
                    <a href="<?php echo site_url('superadmin/cetak_bukti_mutasi_keluar/').$row->nisn; ?>" class="btn btn-warning fa fa-print text-black ">Print Bukti</a>
