  ...
  <div class="row">
    <div class="col-md-12">
     ...
     <div id="myTabContent" class="tab-content">
      ...
      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('superadmin/simpan_form_mutasi'); ?>">
        <?php
                 $i=1;
             ...
             <div class="col-sm-offset-2 col-sm-10">
               <!-- <div class="modal-footer" align="center"> -->
                <a href="<?php echo site_url('superadmin/nonaktifform'); ?>" class="btn btn-danger">Non Aktifkan Formulir</a>
      ...
      <div class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
        <form method="post" action="<?php echo site_url('superadmin/ubah_status_siswa_mutasi');?>">
          <div class="row">
                  <div class="col-sm-4">
                 ...
                 <?php 
                  ...
                  foreach ($tabel_siswa_mutasi_masuk as $row)
                  {
                    ...
                    <tr>
                      ...
                      <td>
                        <a data-toggle="modal" class="btn btn-block btn-primary button-action btnedit" data-show="true" href="<?php echo site_url('superadmin/editpendaftar_mutasi/'.$row->nisn_pendaftar_mutasi); ?>" data-target="#myPendaftar<?php echo $i; ?>">Edit</a>
                      </td>
                      <td>
                       <td>

                     <a onclick="return confirm('Apakah Anda yakin akan menghapus data?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('superadmin/hapus_pendaftar_mutasi/'.$row->nisn_pendaftar_mutasi); ?>" > Hapus </a>
                      </td> 
      ...
      <div class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab2">
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('superadmin/ubah_siswa_akun'); ?>">
               ...
               <?php 
                ...
                <tr>
                  <td><input type="checkbox" class="flat checkNisn" name="nisn_ubah[]" value="<?php echo $row->nisn_pendaftar_mutasi; ?>"></td>
                   ...
                   <td>
                    <button type="button" role="button" class="btn btn-primary" onclick="document.location='<?php echo site_url('superadmin/masukkan_siswa_kelas');?>' + '/' + '<?php echo $row->nisn_pendaftar_mutasi; ?>' + '/' + document.getElementById('cmb<?php echo $row->nisn_pendaftar_mutasi; ?>').value;" >Simpan</button></td>
                   <td>
                    <a href="<?php echo site_url('superadmin/print_bukti_mutasi_diterima/'.$row->nisn_pendaftar_mutasi); ?>" target="_blank" class="btn btn-warning fa fa-print text-black">Print Bukti</a>
                   </td>
                 </tr>
                 <?php
                    $i=$i+1;
      ...
      <div class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
        <form class="form-horizontal formkaldik" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>superadmin/tambah_pengumuman">
             ...
             <table class="table table-striped projects">
              ...
              if (is_array($pengumuman_mutasi) && count($pengumuman_mutasi)) : ?>
                  ...
                  <tr class="odd gradeX">
                    ...
                    <a href="<?php echo base_url('superadmin/download/'.$m->id_pengumuman)?>" class="btn btn-primary btn-xs"><i class="fa fa-download"></i></a>
                    <?php
                    //delete
                    include('delete.php');
                    ?>
