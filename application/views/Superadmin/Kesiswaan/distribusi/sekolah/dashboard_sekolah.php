...
<head>
    ...
    <link href="<?php echo base_url();?>/assets/distribusi/admin/css_s/font-awesome.min.css" rel="stylesheet">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="http://localhost:8000/sia/index.php/kesiswaan/calon_siswa/frontend_ppdb">PPDB</a></li>
