...
<head>
  ...
  <script type="text/javascript" src="<?php echo base_url();?>/assets/distribusi/admin/bootstrap/js/bootstrap.min.js"></script>
            ...
            <!-- User Account: style can be found in dropdown.less -->
             <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url();?>/assets/distribusi/admin/fotosiswa/<?php echo $foto ?>" class="user-image" alt="User Image">
                <span class="hidden-xs"><?php echo $nama?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="<?php echo base_url();?>/assets/distribusi/admin/fotosiswa/<?php echo $foto ?>" class="img-circle" alt="User Image">
...
<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="treeview">
              ...
              <ul class="treeview-menu active">
                <li><a href="<?php echo base_url();?>siswa/daftarulang_ppdb_siswa"><i class="fa fa-circle-o"></i>Siswa Baru</a></li>
                <li class="active"><a href="<?php echo base_url();?>distribusi/siswa/siswa_mutasi"><i class="fa fa-circle-o"></i>Siswa Mutasi</a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li ><a href="<?php echo base_url(); ?>"><i class="fa fa-circle-o"></i>Jadwal </a>
           <ul class="treeview-menu">
      ...
      <li class="treeview active">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="<?php echo base_url();?>distribusi/siswa/klinik_un_siswa"><i class="fa fa-circle-o"></i>Klinik UN </a></li>
      </li>
...
<!-- DataTables -->
<script src="<?php echo base_url();?>/assets/distribusi/admin/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url();?>/assets/distribusi/admin/plugins/datatables/dataTables.bootstrap.min.js"></script>
</body>
<script>
  $(function () {
    $("#example1").DataTable();
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/distribusi/admin/bootstrap/css/jquery.datetimepicker.min.css"/ >
<script type="text/javascript" src="<?php echo base_url();?>assets/distribusi/admin/bootstrap/js/jquery.datetimepicker.full.min.js"></script>
