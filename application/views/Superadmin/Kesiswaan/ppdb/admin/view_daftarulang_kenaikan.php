        ...
        <div id="myTabContent" class="tab-content">
          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
            <div class="form-group">
              ...
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('ppdb/admin/daftarulang_kenaikan/saveformkenaikan'); ?>">  
                ...
                <div class="form-group">  
                  <div class="col-md-9 col-sm-9 col-xs-9">
                    ...
                    <div class="modal-footer" align="right">
                      <a href="<?php echo site_url('ppdb/admin/daftarulang_kenaikan/nonaktif'); ?>" class="btn btn-danger">Non Aktifkan Formulir</a>
                 ...
                 $i=1;
                  foreach ($tabel_pendaftar_daftarulang_kenaikan as $row)
                  {
                    ...
                    <tr>
                      ...
                      <td><a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('ppdb/admin/daftarulang_kenaikan/editberkas/'.$row->nisn); ?>" data-target="#myPendaftar<?php echo $i; ?>">Edit</a>
                      </td>
                    </tr>
