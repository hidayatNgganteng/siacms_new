...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('ppdb/admin/pendaftar_jalur_ujian/updateketentuan/'.$row_ketentuan_ppdb->id_ketentuan); ?>" enctype="multipart/form-data">
          <br>
          ...
          <div class="modal-footer">
            <a type="button" role="button" href="<?php echo site_url('ppdb/admin/pendaftar_jalur_ujian/deleteketentuan/'.$row_ketentuan_ppdb->id_ketentuan); ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin Ketentuan PPDB ini dihapus?');" >Hapus</a>
