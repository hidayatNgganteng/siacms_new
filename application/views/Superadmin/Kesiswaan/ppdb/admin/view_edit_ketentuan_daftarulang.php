...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('ppdb/admin/daftarulang_ppdb/updateketentuan/'.$row_ketentuan_ppdb->id_ketentuan); ?>" enctype="multipart/form-data">
          <br>
          ...
          <div class="modal-footer">
            <a href="<?php echo site_url('ppdb/admin/daftarulang_ppdb/deleteketentuan/'.$row_ketentuan_ppdb->id_ketentuan); ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin data dihapus?');">Hapus</a>
