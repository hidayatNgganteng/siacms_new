...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('ppdb/admin/pendaftar_jalur_ujian/updatependaftarlolos/'.$row_pendaftar_ppdb->nisn_pendaftar); ?>" >
          <br>
