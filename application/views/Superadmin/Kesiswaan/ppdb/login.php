...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/kesiswaan/plugins/iCheck/square/blue.css">
...
<body>
  <div>
    ...
    <div id="kotak">
      <img src="<?php echo base_url();?>assets/kesiswaan/image/smp.png" width="50%">
      <div class="login-logo" style="color:navy">
       <b>SISTEM INFORMASI</b><br>SMP</br>
     </div>

<div class="form-group" style="color:red"> <?php echo $this->session->flashdata('warning')?></div>


<?php echo form_open('login/ceklogin')?>
      <div class="form-group"><input type="text"  class="form-control" name="username"  placeholder="Masukkan Username"></div>
