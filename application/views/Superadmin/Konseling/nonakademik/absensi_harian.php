       ...
       <div class="row">
          <div class="col-md-12">
            <div class="box box-primary">
              ...
              <form role="form" method="post" action="<?php echo site_url('superadmin/simpanperizinan'); ?>">
                <div class="box-body">
         ...
         <div class="col-md-12">
           <div class="box">
             <div class="box-header with-border">
               ...
               <form method="post" action="<?php echo site_url('superadmin/Perizinan'); ?>">
                 <?php
                   $tgl = date('Y-m-d');
              ...
              <table class="table table-bordered">
                ...
                foreach ($absenharian as $rowabsenharian) {
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo site_url('superadmin/deleteperizinan/'.$rowabsenharian->id_absen_harian); ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin?');">Del</a></td>
                  </tr>
                  <?php
                    }
                  ?>
