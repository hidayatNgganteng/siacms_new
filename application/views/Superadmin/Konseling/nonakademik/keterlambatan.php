        ...
        <section class="col-lg-12 ">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
              <li class="active"><a href="<?php echo site_url('superadmin/keterlambatan'); ?>">Keterlambatan Siswa</a></li>
              <li>
                <a href="<?php echo site_url('superadmin/grafik'); ?>" class="dropdown-toggle" data-toggle="dropdown">Grafik</a>
                <ul class="dropdown-menu">
                              <!-- <li><a tabindex="-1" href="<?php //echo site_url('nonakademik/grafik'); ?>#Perkelas">Perkelas</a></li>
                                ...
                                <li><a tabindex="-1" href="<?php echo site_url('superadmin/grafik'); ?>#Bulanan">Bulanan</a></li>
                                <li><a tabindex="-1" href="<?php echo site_url('superadmin/grafik'); ?>#Tahunan">Tahunan</a></li>
                              </ul>
                            </li>
                          </ul>
                          <div class="tab-content no-padding">
                            <div class="chart tab-pane active" id="tab1" style="position: relative; ">
                              <div class="box">
                                ...
                                <form role="form" method="post" action="<?php echo site_url('superadmin/simpanketerlambatan'); ?>">
                                  <div class="box-body">
                              ...
                              <div class="chart tab-pane active" id="tab1" style="position: relative; ">
                                <div class="box">
                                  <div class="box-body">
                                    ...
                                    <select name="id_tahun_ajaran" id="id_tahun_ajaran" onchange="document.location='<?php echo site_url('superadmin/keterlambatan');?>/' + document.getElementById('id_tahun_ajaran').value;">
                                      <option value=""></option>  
                                      <?php
                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      foreach ($keterlambatan as $row_keterlambatan) {
                                        ...
                                        <tr >
                                          <td> Semester 1</td>
                                          <td>
                                            <a data-toggle="modal" data-show="true" href="<?php echo site_url('superadmin/dataketerlambatan/'.$id_tahun_ajaran."/".$row_keterlambatan->jml); ?>" data-target="#myModal<?php echo $row_keterlambatan->orang ?>"><?php echo $row_keterlambatan->orang; ?> Siswa</a>
                                          </td>
                                          <td>
