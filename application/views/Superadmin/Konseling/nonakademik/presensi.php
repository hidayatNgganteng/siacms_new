...
<script>
  $(function () {
    ...
    $("#pp_form").submit(function(){
      var thisform = $(this);
      $.post( "<?php echo site_url("nonakademik/presensi/save") ?>", thisform.serialize(),function( data ) {
    ...
    $("select[name='pp_bulan_report'], select[name='pp_tahun_report']").change(function(){
      ...
      $.post( "<?php echo site_url("nonakademik/presensi/pp_report") ?>", {bulan: sbulan, tahun: stahun},function( data ) {
    ...
    $("#presensisiswaModal button.tampilkan").click(function(){
      ...
      $.post( "<?php echo site_url("nonakademik/presensi/siswa") ?>", {thnajaran: sthnajaran, semester: ssemester, idjadwal: sidjadwal, tanggal: stanggal},function( data ) {
        $("#presensisiswaModal").find(".dtpresensi_siswa").html("");
    ...
    $("#pp_form_siswa").submit(function(){
      ...
      $.post( "<?php echo site_url("nonakademik/presensi/siswa_save") ?>", thisform.serialize(),function( data ) {
    ...
    $("#ps_tampil_tombol").click(function(){
      ...
      $.post( "<?php echo site_url("nonakademik/presensi/siswa_report") ?>", {ekskul: ps_ekskul, tanggal: ps_tanggal},function( data ) {
    ...
    $("#ps2_tampil_tombol").click(function(){
      ...
      $.post( "<?php echo site_url("nonakademik/presensi/siswa_report_pertemuan") ?>", {subaction: "jum_pertemuan", thn_ajaran: ps2_thn_ajaran, semester: ps2_semester, ekskul: ps2_ekskul},function( data ) {
        ...
        $.post( "<?php echo site_url("nonakademik/presensi/siswa_report_pertemuan") ?>", {subaction: "siswa_pertemuan", thn_ajaran: ps2_thn_ajaran, semester: ps2_semester, ekskul: ps2_ekskul},function( data2 ) {
    ...
    $("#pp_tampil_tombol2").click(function(){
      ...
      $.post( "<?php echo site_url("nonakademik/presensi/pembimbing_report") ?>", {subaction: "get_tanggal", tahun: stahun, bulan: sbulan},function( data ) {
        var obj = jQuery.parseJSON( data );
