                ...
                <div class="tab-content no-padding">
                  <div class="chart tab-pane active" id="tab1" style="position: relative; ">
                      ...
                      <div class="box">
                        <div class="box-body">
                        <!-- <br/><br/> -->
                        <form role="form" method="post" action="<?php echo site_url('superadmin/simpanprestasi'); ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Kelasssssss</label>
                  ...
                  <br/>
                  <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Jenis Prestasi</label>
                        <div class="col-md-3 col-sm-4 col-xs-10">
                          <input type="text" name="jenis_prestasi" class="form-control col-md-3 col-xs-12" placeholder="Jenis Prestasi" style="font-size: 14px">
                        </div>
                    </div>
                    <br/>
                    <br/>
