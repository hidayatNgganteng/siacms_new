...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li class="active"><a href="dashsiswa.php">Dashboard</li>
    </ol>
  </section>
      ...
      <div class="col-md-12 ">
        ...
        <div class="box box-primary box-dashboard">
          <div class="box-body box-profile">
            <h3 class="profile-username text-center">Selamat Datang [Nama Siswa]!</h3>
            <img class="profile-user-img img-responsive img-circle" src="image/admin.png" alt="User profile picture">

            <h3 class="profile-username text-center">Siswa</h3>
