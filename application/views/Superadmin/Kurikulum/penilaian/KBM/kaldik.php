            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                 ...
                 <div class="active tab-pane" id="homekaldik">
                   <div class="box">
                    <div class="box-header jarakbox">
                      ...
                      ?>
                      <div class="col-md-12">
                        <a class="pull-right" href="<?php echo site_url('superadmin/cetak/printkaldik'); ?>" ><button class="btnjdwl"><i class="fa fa-upload text-red "></i> Print</button></a>
                      </div>  
                    </div>
                ...
                <div class="tab-pane" id="tambahkaldik">
                 <form class="form-horizontal formkaldik" action="<?php echo site_url('superkur/tambah_kaldik'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <tbody>
                      ...
                      foreach ($kaldik as $rowkaldik) {
                        ...
                        <tr>
                          ...
                          <td> 
                            <a data-toggle="modal" data-show="true" data-target="#editkaldik<?php echo $i; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("superkur/form_edit_kaldik/".$rowkaldik->id_kaldik); ?>" >Edit</a>
                            <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("/superkur/hapus_kaldik/".$rowkaldik->id_kaldik); ?>" onclick="return confirm_delete();">Hapus</a>
                          </td>               
                        </tr>
