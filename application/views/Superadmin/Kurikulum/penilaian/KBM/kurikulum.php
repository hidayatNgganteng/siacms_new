      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          ...
          <div class="tab-pane" id="tambahkurikulum">
           <form class="form-horizontal formkaldik" action="<?php echo base_url('/superkur/tambah_kurikulum'); ?>" method="post" enctype="multipart/form-data" novalidate>
            ...
            <tbody>
              ...
              foreach ($kurikulum as $rowkur) {
                ...
                <tr>
                  ...
                  <td> 
                    <a data-toggle="modal" data-show="true" data-target="#editkur<?php echo $i; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("superkur/form_edit_kurikulum/".$rowkur->id_kurikulum); ?>" >Edit</a>
                    <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("/superkur/hapus_kurikulum/".$rowkur->id_kurikulum); ?>" onclick="return confirm_delete();">Hapus</a>
                  </td>               
                </tr>
