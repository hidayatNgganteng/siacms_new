        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="#"><i class="fa fa-circle-o "></i> Penilaian</a>
           <ul class="treeview-menu active">
            <li class="active"><a href="<?php echo base_url('index.php/Penilaian/nilaisiswa') ?>"><i class="fa fa-circle-o text-red"></i> Nilai Siswa</a></li>
...
function confirm_delete() {
  return confirm('Apakah yakin ini akan dihapus?');
}
</script>