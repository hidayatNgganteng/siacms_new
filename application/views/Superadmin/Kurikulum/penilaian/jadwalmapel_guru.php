...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center style="color:navy;">Jadwal Mata Pelajaran SMP Yogyakarta <br></center>
                  ...
                  <div class="box-body">
                    <table class="table table-bordered table-striped tabelmapel">
                      ...
                      <tr class="btnpilih">
                        ...
                        <th>06.00 - 07.00</th>
                        <th>
                          <button class="btn btn-success button-form"  data-toggle="modal" data-target="#review4">Pilih guru</button>
                        </th>
                         <th>
                         <button class="btn btn-success button-form"  data-toggle="modal" data-target="#review4">Pilih guru</button>
                        </th>
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped tabelmapel">
                      ...
                      <tr class="btnpilih">
                        ...
                        <th>06.00 - 07.00</th>
                        <th>
                          <button class="btn btn-success button-form"  data-toggle="modal" data-target="#review5">Pilih guru</button>
                        </th>
                         <th>
                         <button class="btn btn-success button-form"  data-toggle="modal" data-target="#review5">Pilih guru</button>
                        </th>
                      ...
                      <tr>
                        ...
                        <th>
                          <select class="kodeguru">
                           <option class="merah">1</option>
                           <option class="kuning">2</option>
                           <option class="ungu">3</option>
                           <option class="hijau">4</option> 
                          </select>
                        </th>
                         <th>
                          <select class="kodeguru">
