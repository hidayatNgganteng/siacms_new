...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center style="color:navy;">Jadwal Mengajar SMP Yogyakarta <br></center>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#jadwalmengajar" data-toggle="tab">Lihat Jadwal Mengajar Guru</a></li>
              <li><a href="#kelolajadwalmengajar" data-toggle="tab" alt="test kursor">Kelola Jadwal mengajar Guru</a></li>
            </ul>
            <div class="tab-content">
              <div class="active tab-pane" id="jadwalmengajar">
                <div class="box">
              ...
              <!-- /.tab-pane -->
              <div class="tab-pane" id="kelolajadwalmengajar">
                <div class="box">
