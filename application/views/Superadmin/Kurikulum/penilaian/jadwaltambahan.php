...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <li class="treeview active">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="jadwalpiketguru.php"><i class="fa fa-circle-o"></i> Jadwal Piket Guru</a></li>
      ...
      <li class="treeview active">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="jenisnilaiakhir.php"><i class="fa fa-circle-o"></i> Jenis Nilai</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center style="color:navy;">Jadwal Tambahan SMP Yogyakarta <br></center>
              ...
              <div class="tab-pane" id="kelolajadwaltambahan">
                <div class="box">
                  ...
                  <div class="box-body">
                    ...
                    <a href="#jadwalmapel" data-toggle="tab"><button class="btnjdwl"><i class="fa fa-print text-red "></i> Submit</button></a>
                  </div>
                </div>
              </div>
