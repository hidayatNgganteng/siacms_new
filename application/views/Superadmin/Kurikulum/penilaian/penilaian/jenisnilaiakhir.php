          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane" id="tambahkurikulum">
               <form class="form-horizontal formmapel" method="post" action="<?php echo base_url('superpen/tambah_jenisnilai'); ?>">
                    ...
                    <tbody>
                      ...
                      foreach ($jenis_nilai_akhir as $a){
                        ...
                        echo "<td>"; ?>
                          ...
                          <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("superpen/hapus_jenisnilai/".$a->id_jenis_na); ?>" onclick="return confirm_delete();">Hapus</a>
                          <?php
                          echo "</tr>";
                          ?>
