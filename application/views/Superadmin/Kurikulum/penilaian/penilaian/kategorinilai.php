        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane" id="tambahkurikulum">
             <form class="form-horizontal formmapel" action="<?php echo base_url('superpen/tambah_katnilai'); ?>" method="post">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   ...
                   foreach($kategori_nilai as $a){
                    ...
                    echo "<td>{$a->bobot}</td>";
                    echo "<td>"; ?>
                      <a data-toggle="modal" data-show="true" data-target="#editkategorinilai<?php echo $no; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("superpen/form_edit_kategori/".$a->id_kategorinilai); ?>" >Edit</a>
                      <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("superpen/hapus_katnilai/".$a->id_kategorinilai); ?>" onclick="return confirm_delete();">Hapus</a>
                      <?php
                      echo "</tr>";
                      ?>
