        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane" id="tambahkurikulum">
             <form class="form-horizontal formmapel" method="post" action="<?php echo base_url('superpen/tambah_kompetensi'); ?>">
              <div class="bigbox-mapel"> 
                <div class="box-mapel">
                  <select id="pilihkelaskd" onchange="document.location='<?php echo site_url('superpen/Kompetensi'); ?>/'+document.getElementById('pilihkelaskd').value+'/'+document.getElementById('pilihmapelkd').value;">
                    <option value="" ></option>
                    <?php
                  ...
                  <!--form class=""-->
                    <select id="pilihmapelkd" name="id_mapel" onchange="document.location='<?php echo site_url('superpen/Kompetensi'); ?>/'+document.getElementById('pilihkelaskd').value+'/'+document.getElementById('pilihmapelkd').value;">
                      <?php
                      foreach ($mapel as $x){
                        ?>
            ...
            <div class="active tab-pane" id="lihatNA">
              <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <select id="pilihkelaskdview" onchange="document.location='<?php echo site_url('superpen/Kompetensi'); ?>/'+document.getElementById('pilihkelaskdview').value+'/'+document.getElementById('pilihmapelkdview').value;">
                    <option value="" ></option>
                    <?php
                  ...
                  <!--form class=""-->
                    <select id="pilihmapelkdview" name="id_mapel" onchange="document.location='<?php echo site_url('superpen/Kompetensi'); ?>/'+document.getElementById('pilihkelaskd').value+'/'+document.getElementById('pilihmapelkdview').value;">
                      <?php
                      foreach ($mapel as $x){
                        ?>
                        <option value="<?php echo $x->id_mapel;?>" <?php if ($id_mapel == $x->id_mapel) { echo " selected"; } ?>><?php echo $x->nama_mapel; echo $x->jenjang?></option>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      foreach ($k_dasar as $a){
                        ...
                        echo "<td>"; ?>
                          <a data-toggle="modal" data-show="true" data-target="#editjenisnilai<?php echo $no; ?>" class="btn btn-block btn-primary button-action btnedit" href="<?php echo base_url("superpen/form_edit_jenisNilai/".$a->id_jenis_na); ?>" >Edit</a>
                          <a type="button" style="background: red ; border: red;" class="btn btn-block btn-primary button-action btnhapus " href="<?php echo base_url("superpen/hapus_kompetensi/".$a->id_kd); ?>" onclick="return confirm_delete();">Hapus</a>
                          <?php
                          echo "</tr>";
                          ?>
