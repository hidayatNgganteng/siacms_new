          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <form>
               ...
               <form id="formmapel" style="display:block;" class="form-horizontal formmapel" method="post" action="<?php echo site_url('superjadw/simpanmapel'); ?>">
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td> 
                          <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('superjadw/mapel/'.$row_mapel->id_kelas_reguler.'/'.$row_mapel->jenjang.'/'.str_replace(" ", "_", $row_mapel->id_namamapel)); ?>" > Edit </a>
                          <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('superjadw/hapusmapelbyidjenjang/'.$row_mapel->id_kelas_reguler.'/'.$row_mapel->jenjang.'/'.str_replace(" ", "_", $row_mapel->id_namamapel)); ?>" > Hapus </a>
                        </td>               
                      </tr>
                      <?php
