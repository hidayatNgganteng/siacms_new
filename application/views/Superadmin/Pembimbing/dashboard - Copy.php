      ...
      <section class="sidebar">
        ...
        <ul class="treeview-menu">
            <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url();?>pembimbing/pendaftaran"><i class="fa fa-circle-o text-red"></i>Pendaftaran</a></li>
                <li><a href="<?php echo base_url();?>pembimbing/jadwal"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
                <li><a href="<?php echo base_url();?>pembimbing/presensi"><i class="fa fa-circle-o text-red"></i> Presensi</a></li>
                <li><a href="<?php echo base_url();?>pembimbing/nilai"><i class="fa fa-circle-o text-red"></i> Nilai</a></li>
                <li><a href="<?php echo base_url();?>pembimbing/pembayaran"><i class="fa fa-circle-o text-red"></i> Pendanaan</a></li>
              </ul>
            </li>
          </ul>
        </li> 
