...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo site_url('pembimbing');?>" class="logo">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo site_url('pembimbing/profile');?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
        ...
        <ul class="sidebar-menu">
          ...
          if (in_array("1", $arrmenuakses)) {
                  ...
                  <li ><a href="#"><i class="fa fa-circle-o"></i> Penerimaan Peserta Didik Baru </a>
                   <ul class="treeview-menu">
                    ...
                    if (in_array("3", $arrmenuakses)) {
                      ?>
                      <li ><a href="<?php echo base_url();?>pembimbing/ppdbujian"><i class="fa fa-circle-o text-red"></i> PPDB Ujian</a></li>
                      <?php
                    }
                    ?>
                    ...
                    if (in_array("4", $arrmenuakses)) {
                      ?>
                      <li ><a href="<?php echo base_url();?>pembimbing/ppdbneg"><i class="fa fa-circle-o text-red"></i> PPDB UN</a></li>
                      <?php
                    }
                    ?>
                  </ul>
                ...
                <li ><a href="#"><i class="fa fa-circle-o"></i> Daftar Ulang </a> 
                 <ul class="treeview-menu">
                  ...
                  if (in_array("6", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>pembimbing/daftarulang"><i class="fa fa-circle-o text-red"></i>Peserta Didik Baru</a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("7", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>pembimbing/daftarkenaikan"><i class="fa fa-circle-o text-red"></i>Kenaikan Kelas</a></li>
                    <?php
                  }
                  ?>
                </ul>
              ...
              <li><a href="#"><i class="fa fa-circle-o"></i> Distribusi Kelas </a>
                <ul class="treeview-menu">
                  ...
                  if (in_array("9", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo site_url('pembimbing/distribusi_reg');?>"><i class="fa fa-circle-o text-red"></i> Kelas Reguler </a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("10", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo site_url('pembimbing/distribusi_tam');?>"><i class="fa fa-circle-o text-red"></i> Kelas Tambahan </a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("11", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>pembimbing/klinik_un"><i class="fa fa-circle-o text-red"></i> Klinik UN</a></li>
                    <?php
                  }
                  ?>
                </ul>
              ...
              <li><a href="#"><i class="fa fa-circle-o"></i> Mutasi </a>
                <ul class="treeview-menu">
                  ...
                  if (in_array("13", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>pembimbing/mutasi_masuk"><i class="fa fa-circle-o text-red"></i> Mutasi Masuk</a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("14", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>pembimbing/mutasi_keluar"><i class="fa fa-circle-o text-red"></i> Mutasi Keluar</a></li>
                    <?php
                  }
                  ?>
                </ul>
            ...
            if (in_array("15", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>pembimbing/bukuinduk"><i class="fa fa-circle-o"></i>Buku Induk</a></li>
              <?php
            }
            ?>
              ...
              <li ><a href="#"><i class="fa fa-circle-o"></i> Penjadwalan</a>
               <ul class="treeview-menu">
                ...
                if (in_array("18", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('pembimbing/namamapel'); ?>"><i class="fa fa-circle-o text-red"></i> Tambah Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("19", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('pembimbing/mapel'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("20", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('pembimbing/harirentang'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Hari & Jam</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("21", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('pembimbing/jammengajar'); ?>"><i class="fa fa-circle-o text-red"></i> Jam Mengajar Guru</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("22", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('pembimbing/jadwalmapel'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("23", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('pembimbing/jadwalpiketguru'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Piket Guru</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("24", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('pembimbing/jadwaltambahan'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Tambahan</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("25", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('pembimbing/Ekstrakurikuler'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Ekstrakurikuler</a></li>
                  <?php
                }
                ?>
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
      ...
      if (in_array("37", $arrmenuakses)) {
        ?>
        <li><a href="<?php echo site_url('kurikulum/pegawaibaru');?>"><i class="fa fa-circle-o"></i>Data Pegawai</a></li>
        <?php
      }
      ?>
      ...
      if (in_array("38", $arrmenuakses)) {
        ?>
        <li><a href="<?php echo site_url('kurikulum/presensipegawai');?>"><i class="fa fa-circle-o"></i>Presensi Pegawai</a></li>
        <?php
      }
      ?>
        ...
        <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Bimbingan Konseling</a>
         <ul class="treeview-menu">
          ...
          if (in_array("47", $arrmenuakses)) {
            ?>
            <li ><a href="<?php echo base_url();?>kurikulum/keterlambatan"><i class="fa fa-circle-o text-red"></i> Keterlambatan & Jam</a></li>
            <?php 
          }
          ?>
          ...
          if (in_array("48", $arrmenuakses)) {
            ?>
            <li><a href="<?php echo base_url();?>kurikulum/absensi_harian"><i class="fa fa-circle-o text-red"></i> Perizinan</a></li>
            <?php 
          }
          ?>
          ...
          if (in_array("49", $arrmenuakses)) {
            ?>
            <li><a href="<?php echo base_url();?>kurikulum/pelanggaran"><i class="fa fa-circle-o text-red"></i> Pelanggaran</a></li>
            <?php 
          }
          ?>
          ...
          if (in_array("50", $arrmenuakses)) {
            ?>
            <li><a href="<?php echo base_url();?>kurikulum/prestasi"><i class="fa fa-circle-o text-red"></i> Prestasi</a></li>
            <?php 
          }
          ?>
        </ul>
...
?>
  ...
  <li class="header">OPTIONAL</li>
      ...
      <ul class="treeview-menu">
        <li><a href="<?php echo site_url('pembimbing/gantipassword');?>">Ganti Password</a></li> 
      </ul> 
    </li>
