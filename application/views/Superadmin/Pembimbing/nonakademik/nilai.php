        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content no-padding">
            <div class="chart tab-pane active" id="tab1" style="position: relative; ">
              ...
              <div class="box">
                <form method="post" action="<?php echo site_url('superadmin/simpan_nilai/'.$id_kelas_reguler); ?>">
                  <div class="box-body">
                    <select name="id_kelas_reguler1" id="id_kelas_reguler1" onchange="document.location = '<?php echo site_url('superadmin/nilai'); ?>'+'/'+document.getElementById('id_kelas_reguler1').value + '/<?php echo $id_tahun_ajaran; ?>';">
                     <option value="">...</option>
                     <?php
                    ...
                    <div class="chart tab-pane" id="tab2" style="position: relative; ">
                     <div class="box">
                      <div class="box-body">
                        ...
                        <select name="id_tahun_ajaran" id="id_tahun_ajaran" onchange="document.location='<?php echo site_url('superadmin/nilai');?>/<?php echo $id_kelas_reguler; ?>/' + document.getElementById('id_tahun_ajaran').value;">
                          <option value=""></option>  
                          <?php
                        ...
                        <select name="id_kelas_reguler2" id="id_kelas_reguler2" onchange="document.location = '<?php echo site_url('superadmin/nilai'); ?>'+'/'+document.getElementById('id_kelas_reguler2').value + '/<?php echo $id_tahun_ajaran; ?>';">
                         <option value="">...</option>
                         <?php
                         foreach ($kelas_reguler as $row) {
                          ?>
