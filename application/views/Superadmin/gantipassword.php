          ...
          <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-pane" id="gantipassword">
                ...
                <form class="form-horizontal formmapel" method="post" action="<?php echo site_url('superadmin/updatepassword'); ?>">
                  ...
                  <div class="box-mapel" style="padding: 2% 0">
                      ...
                      <button type="submit" role="button" class="btn btn-danger">Ganti Password</button>
                         ...
                         <a href="<?php echo site_url('superadmin/pegawaibaru');?>" type="button" role="button" class="btn btn-danger">Cancel</a>
