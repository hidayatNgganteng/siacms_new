...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <center style="color:navy;">Total Data Pensiun SMP Yogyakarta <br></center>
      <br>
    </h1>
  </section>
      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          ...
          <ul class="nav nav-tabs">
            <li class="active"><a href="#datapegawai" data-toggle="tab">Lihat Data Pensiun</a></li>
                  ...
                  <div class="box">
                    ...
                    <table id="example1" class="table table-bordered table-striped" > 
                      ...
                      <tbody>
                        ...
                        <?php
                        $no=1;
                        foreach ($datpegpensiun->result() as $key) { ?>
                        <tr>
                          <td><?php echo $no?></td>
