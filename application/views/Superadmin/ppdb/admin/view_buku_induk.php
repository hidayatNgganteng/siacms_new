  ...
  <section class="content">
    ...
    <div class="col-md-12">
      <div class="nav-tabs-custom">
        <br>
        <form method="post" action="<?php echo site_url('suppdb/admin/buku_induk/ubahstatus');?>">
        <table class="table table-striped projects" id="example1">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>                        
                <a data-toggle="modal" class="btn btn-default btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/buku_induk/editsiswa/'.$row->nisn); ?>" data-target="#mySiswa<?php echo $i; ?>">Siswa</a>
              </td>
              <td>                        
                <a data-toggle="modal" class="btn btn-default btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/buku_induk/editsiswaortu/'.$row->nisn); ?>" data-target="#myOrtu<?php echo $i; ?>">Orang Tua</a>
              </td>
              <td>                        
                <a data-toggle="modal" class="btn btn-default btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/buku_induk/editsiswawali/'.$row->nisn); ?>" data-target="#myWali<?php echo $i; ?>">Wali</a>
              </td>
            </tr>
