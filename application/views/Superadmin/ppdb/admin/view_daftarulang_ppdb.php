<div class="content-wrapper">
          ...
          <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
              <div class="form-group">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('suppdb/admin/daftarulang_ppdb/saveformppdb'); ?>">  
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                      ...
                      <div class="modal-footer" align="left">
                        <a href="<?php echo site_url('suppdb/admin/daftarulang_ppdb/nonaktif'); ?>" class="btn btn-danger">Non Aktifkan Formulir</a>
  ...
  <!-- ========================================= end tab 1 ============================================== -->
              ...
              <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('suppdb/admin/daftarulang_ppdb/saveketentuan'); ?>" enctype="multipart/form-data">
                  <div class="form-group">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>                        
                    <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/daftarulang_ppdb/editketentuan/'.$row->id_ketentuan); ?>" data-target="#myKetentuanDU<?php echo $row->id_ketentuan; ?>">Edit</a>
                  </td>
                  <td>
              ...
              <div class="col-sm-4">
                <div class="dataTables_length" id="example1_length">
                  <div class="form-group" align="right">
                    <a type="button" role="button" href=<?php echo site_url('suppdb/admin/daftarulang_ppdb/eksportujian');?> class="btn btn-default"><i class="fa fa-print text-red "></i> Export Data Pendaftar</a>
                  </div>
                </div>
              </div>
            </div>
            <table class="table table-striped projects" id="example2">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                     <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/daftarulang_ppdb/editberkas/'.$row->nisn); ?>" data-target="#myPendaftar<?php echo $i; ?>">Edit</a>
                  </td>
                </tr>
...
<!-- =============================== END OF TAB CONTENT 4 ================================== -->
          ...
          <div role="tabpanel" class="tab-pane fade" id="tab_content5" aria-labelledby="profile-tab">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('suppdb/admin/daftarulang_ppdb/savepengumuman'); ?>" enctype="multipart/form-data">
              <div class="form-group">
        ...
        <table class="table table-striped projects" id="example2">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>                        
                <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/daftarulang_ppdb/editpengumuman/'.$row->id_pengumuman_ppdb); ?>" data-target="#myPengumuman<?php echo $i; ?>">Edit</a>
              </td>
              <td>
