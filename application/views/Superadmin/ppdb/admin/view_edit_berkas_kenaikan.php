...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('suppdb/admin/daftarulang_kenaikan/updatependaftar/'.$row_pendaftar_daftarulang_kenaikan->nisn); ?>">
