...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('suppdb/admin/pendaftar_jalur_un/updatependaftar/'.$row_pendaftar_ppdb->nisn_pendaftar); ?>" >
          <br>
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">No Pendaftaran </label>
              <div class="col-md-3 col-sm-3 col-xs-3">
                <input type="text" class="form-control" required="required" name="nomor_pendaftaran" value="<?php echo $row_pendaftar_ppdb->nomor_pendaftaran; ?>">
              </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="tempat_lahir" required="required" value="<?php echo $row_pendaftar_ppdb->tempat_lahir; ?>">
                        </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
                        ...
                        <fieldset>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="date" class="form-control" id="tgl_berlaku" placeholder="Tgl Berlaku" name="tanggal_lahir" required="required" value="<?php echo $row_pendaftar_ppdb->tanggal_lahir; ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              <textarea class="form-control" rows="5" required="required" name="alamat"><?php echo $row_pendaftar_ppdb->alamat; ?></textarea>
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-3">
              <input required="required" id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="tahun_lulus" value="<?php echo $row_pendaftar_ppdb->tahun_lulus; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Pilihan 1 </label>
             <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control" name="pilihan_sekolah_1" value="<?php echo $row_pendaftar_ppdb->pilihan_sekolah_1; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Pilihan 2 </label>
             <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control" name="pilihan_sekolah_2" value="<?php echo $row_pendaftar_ppdb->pilihan_sekolah_2; ?>">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Pilihan 3 </label>
             <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control" name="pilihan_sekolah_3" value="<?php echo $row_pendaftar_ppdb->pilihan_sekolah_3; ?>">
            </div>
          </div>
          <?php
          }
