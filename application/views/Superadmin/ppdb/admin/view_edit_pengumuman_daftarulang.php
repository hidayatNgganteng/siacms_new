...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('suppdb/admin/daftarulang_ppdb/updatepengumuman/'.$row_pengumuman_ppdb->id_pengumuman_ppdb); ?>" enctype="multipart/form-data">
          <br>
          ...
          <div class="modal-footer">
            <a href="<?php echo site_url('suppdb/admin/daftarulang_ppdb/deletepengumuman/'.$row_pengumuman_ppdb->id_pengumuman_ppdb); ?>" onclick="return confirm('Apakah yakin data dihapus?');" class="btn btn-danger">Hapus</a>
