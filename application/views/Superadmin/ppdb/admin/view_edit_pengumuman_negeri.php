...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('suppdb/admin/pendaftar_jalur_un/updatepengumuman/'.$row_pengumuman_ppdb->id_pengumuman_ppdb); ?>" enctype="multipart/form-data">
          <br>
          ...
          <div class="modal-footer">
            <a href="<?php echo site_url('suppdb/admin/pendaftar_jalur_un/deletepengumuman/'.$row_pengumuman_ppdb->id_pengumuman_ppdb); ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin data dihapus?');">Hapus</a>
