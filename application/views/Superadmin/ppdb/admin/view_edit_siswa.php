...
<body>
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('suppdb/admin/buku_induk/updatesiswa/'.$row_siswa->nisn); ?>" enctype="multipart/form-data">
          <br>
