       ...
       <!-- page content -->
          ...
          <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/saveformswasta'); ?>">  
                  ...
                  <h4 class="box-title"><center><b>Pengaturan Formulir</b></center></h4>    
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                      ...
                      <div class="modal-footer" align="center">
                        <a href="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/nonaktifform'); ?>" class="btn btn-danger">Non Aktifkan Formulir</a>
...
<!-- ========================================= end tab 1 =============================================== -->
            ...
            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
              ...
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/saveketentuan'); ?>" enctype="multipart/form-data">
                <div class="form-group">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/editketentuan/'.$row->id_ketentuan); ?>" data-target="#myKetentuan<?php echo $i; ?>">Edit</a>
                  </td>
   ...
   <!-- =========================================== end tab 2 ============================================= -->
            ...
            <div class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
              <div class="tab-pane">
                <h4><center><b>Pengaturan Ujian</b></center></h4>
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/saveformujian'); ?>" >
                    <div class="form-group">
                      <script type="text/javascript">
                        function cekujian() 
                        {
      ...
      <!-- ========================================= end tab 3 ========================================= -->
            ...
            <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
              ...
              <form method="post" action="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/ubahstatus');?>">
                <table class="table table-striped projects" id="example1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                         <a data-toggle="modal" class="btn btn-default btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/editnilai/'.$row->nisn_pendaftar); ?>" data-target="#myNilai<?php echo $i; ?>">Detail Nilai</a>
                      </td>
                      <td><?php echo $row->domisili; ?></td>
                      <td><?php echo $row->terverifikasi; ?></td>
                      <td><?php echo $row->status_siswa; ?></td>
                      <td>
                        <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/editpendaftar/'.$row->nisn_pendaftar); ?>" data-target="#myPendaftar<?php echo $i; ?>">Edit</a>
                      </td>
                    </tr>
                    <?php
                    $i=$i+1;
  ...
  <!-- ===================================== END OF TAB CONTENT 4 ====================================== -->
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="dataTables_length" id="example1_length">
                      <div class="form-group" align="right">
                        <a type="button" role="button" href=<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/eksportujian');?> class="btn btn-default"><i class="fa fa-print text-red "></i> Export Data Pendaftar</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-4">
                    <div class="dataTables_length" id="example1_length">
                      <div class="form-group">
                        <a type="button" role="button" class="btn btn-default" href=<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/buatakun');?> onclick="return confirm('Apakah anda yakin data pendaftar yang lolos sudah benar dan akan dibuatkan akun siswa?');"><i class="fa fa-user text-blue" aria-hidden="true"></i> Buat akun siswa</a>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <tbody>
                      ...
                      foreach ($tabel_pendaftar_ppdb_lolos as $row) 
                      {
                        ...
                        <tr>
                          ...
                          <td><?php echo $row->total_nilai; ?></td>
                          <td>
                           <a data-toggle="modal" class="btn btn-default btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/editnilai/'.$row->nisn_pendaftar); ?>" data-target="#myNilaiLolos<?php echo $i; ?>">Detail Nilai</a>
                          </td>
                          <td>
                           <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/editpendaftarlolos/'.$row->nisn_pendaftar); ?>" data-target="#myPendaftarlolos<?php echo $i; ?>">Edit</a>
                          </td>
                        </tr>
    ...
    <!-- ===================================== END OF TAB CONTENT 5 ================================== -->
         ...
         <div role="tabpanel" class="tab-pane fade" id="tab_content6" aria-labelledby="profile-tab">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/savepengumuman'); ?>" enctype="multipart/form-data">
              <div class="form-group">
              ...
              <table class="table table-striped projects" id="example2">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>                        
                      <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('suppdb/admin/pendaftar_jalur_ujian/editpengumuman/'.$row->id_pengumuman_ppdb); ?>" data-target="#myPengumuman<?php echo $i; ?>">Edit</a>
                    </td>
                    <td>
