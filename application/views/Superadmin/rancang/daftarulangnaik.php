...
<aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <li class="active"><a href="daftarulangnaik.php"><i class="fa fa-circle-o"></i>Kenaikan Kelas</a></li>
      </ul>
      </li>
      </ul>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <center style="color:navy;">Daftar Ulang Kenaikan Kelas</center>
    </h1>
    <ol class="breadcrumb">
      <li class="active">
            <a href="dashboard.php">Dashboard</li>
    </ol>
            </a>
</section>
