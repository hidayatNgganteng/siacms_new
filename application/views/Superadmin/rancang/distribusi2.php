     ...
     <div class="row">
        ...
        <div class="col-md-12">
           <div class="nav-tabs-custom">
            ...
            <li><a href="#tab_content3" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Tambah Kelas</a>
            </li>
            </ul>
                  ...
                  <div class="bigbox-mapel"> 
                    <div class="box-mapel">
                     <div class="nav-tabs-custom2">
                      <ul class="nav nav-tabs">
                       <li class="active"><a href="#" id="home-tab" role="tab" data-toggle="tab" aria-expanded="false">Kelas 7 - 8</a>
                       </li>
                       <li><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Kelas 9</a>
                       </li>
                        </ul>
                      </div>
                  ...
                  <div class="form-group">
                        ...
                        <!-- <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                          <select class="form-control">
                            <option>- Jenis Kelas -</option>
                            <option>Jam Belajar Tambahan</option>
                          </select>
                        </div> -->
                  </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                             <a href="pembagian_tambahan.php"><button type="button" class="btn btn-primary">Bagi Kelas</button></a>
                          </div>
                        </div>
                  ...
                  <div class="bigbox-mapel"> 
                    <div class="box-mapel">
                     <div class="nav-tabs-custom2">
                      <ul class="nav nav-tabs">
                       <li><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="false">Kelas 7 - 8</a>
                       </li>
                       <li class="active"><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Kelas 9</a>
                       </li>
                        </ul>
                      </div>
                     <div class="form-group formgrup jarakform">
                  ...
                  <div class="form-group">
                      ...
                      <div class="form-group formgrup jarakform">
                        <label for="hasil-tes-pendalaman-materi" class="control-label col-md-3">Hasil TPM</label>
                        <div class="col-md-2 col-sm-4 col-xs-12 form-group">
                          <input type="file" data-role="magic-overlay" data-target="#pictureBtn" data-edit="insertImage" class="form-control" id="hasil-tpm" placeholder="Hasil TPM">
                        </div>
                      </div>
                      </div>
                    ...
                    <div class="tambahkelas">
                     <i class="fa fa-plus-circle text-red"></i><a style="color:red" href="#" id="tambahkelas"> Tambah kelas</a>
                      ...
                      <div class="bagikelas">
                     <a href="#"><button type="button" class="btn btn-primary">Bagi Kelas</button></a>
                      </div>
