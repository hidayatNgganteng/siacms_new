      ...
      <ul class="treeview-menu active">
        <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Penjadwalan</a>
          <ul class="treeview-menu active">
            ...
            <li class="active"><a href="jadwaltambahan.php"><i class="fa fa-circle-o text-red"></i> Jadwal Tambahan</a></li>
          </ul>
        </li>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#kelolajadwaltambahan" data-toggle="tab">Kelola Jadwal Tambahan</a></li>
