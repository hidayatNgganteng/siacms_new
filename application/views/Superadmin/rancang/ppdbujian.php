...
<br>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> <input type="text"></p>
                          </li>
                          <li>
                            <p>
                              <input type="checkbox" class="flat"> <input type="text"></p>
...
<br>
                    ...
                    <br>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nilai Bawah <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
