               ...
               <form class="form-horizontal formmapel">
                  <div class="bigbox-mapel"> 
                    <div class="box-mapel">
                      ...
                      <div class="form-group formgrup jarakform">
                        <label for="inputKurikulum" class="col-sm-2 control-label">Jenis Kelas</label>
                        <div class="col-sm-4">
                          <select class="select2_single form-control" tabindex="-1">
                            <option>-Pilih Jenis-</option>
                            <option>Ekstrakulikuler Wajib</optnion>
                            <option>Ekstrakulikuler Pilihan</option>
                            <option>Jam Belajar Tambahan</option>
                            <option>Klinik UN</option>
                          </select>
                        </div>
                      </div>
