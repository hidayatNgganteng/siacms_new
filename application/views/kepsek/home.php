  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/superadmin/homeplugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>kepsek"><i class="fa fa-dashboard"></i> Home</a></li>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="<?php echo base_url();?>Kepsek/homedatapegawai" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url();?>Kepsek/homedataguru" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo base_url();?>kepsek/homedatapensiun" class="small-box-footer">More info <i classs="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
              ...
              <div class="chart tab-pane active" id="grafik" style="position: relative;">
               ...
               <div class="chart tab-pane " id="usia" style="position: relative;">
                <div class="box-body">
                  <div id="grafikusia"></div>
                   <a href="<?php echo site_url('kepsek/grafikusia'); ?>" class="btnjdwl btn btn-default"><i class="fa fa-bar-chart-o text-red "></i> Lihat Pegawai</a>
                </div>
              </div>
               ...
               <div class="chart tab-pane " id="pendidikan" style="position: relative;">
                <div class="box-body">
                  ...
                  <a href="<?php echo site_url('kepsek/grafikpendidikan'); ?>" class="btnjdwl btn btn-default"><i class="fa fa-bar-chart-o text-red "></i> Lihat Pegawai</a>
                </div>
              </div>
               ...
               <div class="chart tab-pane " id="pensiun" style="position: relative;">
                <div class="box-body">
                  ...
                  <a href="<?php echo site_url('kepsek/grafikpensiun'); ?>" class="btnjdwl btn btn-default"><i class="fa fa-bar-chart-o text-red "></i> Lihat Pegawai</a>
                </div>
              </div>
