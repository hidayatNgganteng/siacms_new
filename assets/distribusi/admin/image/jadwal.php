      ...
      <ul class="treeview-menu">
        <li class="active treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="jadwal.php"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
                        ...
                        <h4>Jadwal Ekstrakurikuler</h4>
                          <table class="table table-bordered">
                            ...
                            <tr>
                              <td>2.</td>
                              <td>Selasa</td> 
                              <td>14.00 - 16.00 <br/> 13.00 - 15.00 <br/> 15.00 - 16.30</td>
                                <td>Basket <br/> Futsall <br/> Pencak Silat </td>
                              <td>Lapangan Basket <br/> Sporthall <br/> Ruang Kelas</td>
                              <td>Agus <br/> Aisyah <br/> Faisal </td>
                            </tr>
                          </table>
                        </div>
                            ...
                            <h4>Kelola Jadwal Ekstrakurikuler</h4>
                              <table class="table table-bordered">
                                  ...
                                  <td>
                                    ...
                                    <div id="eks">
                                      <select name="eks12" id="eks12">
                                        ...
                                        <option value="Food ball">Food ball</option>
                                      </select>
                                    <br />
                                    </div>
                                ...
                                <tr>
                                  <td>2.</td>
                                  <td>Selasa</td> 
                                  <td>14.00 - 16.00<br/>15.00 - 16.30</td>
                                  <td>
                                  ...
                                  <td>AULA <br/> Lapangan</td>
                                  <td>Agus <br/> Aisyah</td>
                                  <td>
