            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Data Peserta Ekstrakurikuler</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td>3.</td>
                      <td>Khansa Salsabila</td> 
                      <td>8A</td>
                    </tr>
                    <tr>
                    <td>4.</td>
                      <td>Shabrina Erika</td> 
                      <td>7D</td>
                    </tr>
                    <tr>
                    <td>5.</td>
                      <td>Annisa Wulandari</td> 
                      <td>8C</td>
                    </tr>
                     <tr>
                    <td>6.</td>
                    ...
                    <td>11.</td>
                     ...
                     <tr>
                    <td>12.</td>
                      <td>Diana Khairani</td> 
                      <td>7A</td>
                    </tr>
                     <tr>
                    <td>13.</td>
                      <td>Chealse Olivia</td> 
                      <td>8F</td>
                    </tr>
                     <tr>
                    <td>14.</td>
                    ...
                    <td>16.</td>
                     ...
                     <tr>
                    <td>17.</td>
                      <td>Muhammad Rasya</td> 
                      <td>7A</td>
                    </tr>
                     <tr>
                    <td>18.</td>
                      <td>Muzammil Hasballah</td> 
                      <td>7A</td>
                    </tr>
                     <tr>
                    <td>19.</td>
