 ...
 <ul class="sidebar-menu">
      ...
      <ul class="treeview-menu">
        <li class="active treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pembayaran.php"><i class="fa fa-circle-o text-red"></i> Pendanaan</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center style="color:navy;">Sumbangan Ekstrakurikuler SMP Yogyakarta<br></center>
            ...
            <section class="col-lg-12 ">
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-left">
                  <li class="active"><a href="#tab1" data-toggle="tab">Sejarah Pendanaan</a></li> 
                </ul>
                      ...
                      <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                              ...
                              <td>Sudah Bayar</td>
                              <td>
                                <i class="fa fa-info"></i><a href="#">info</a> 
                                <i class="fa fa-download"></i><a href="#">download</a> 
                              </td>
                            </tr> 
                          </table>
                        </div>
